(function(m, t, A) {
    ...
    function ua(a, b) {
        ...
        if (.01 > Math.random()) try {
            var d = a && a.message || "";
            (c = -1 < d.indexOf("network error occurred") || -1 < d.indexOf("send beacon") && -1 < d.indexOf("Content Security Policy")) || (new Ka).log("jserrs", ya, a.message, b, L.href, "", "string" === typeof a.stack && a.stack.replace(/\n/g, "\\n"))
        } catch (f) {}
    }

    function I(a, b, c, d) {
        return m.setTimeout(D(a, c || "setTimeout", d), b)
    }
    ...
    function Sb(a, b, c, d, f) {
        ...
        function F(a) {
            if (!a.nodeName) return a[X] = -1, null;
            var e = +a[X];
            ...
            (k = k ? v.getElementRegion(k) : null) && B[0] == k[0] && B[1] == k[1] && B[2] == k[2] && B[3] == k[3] && (b |= 8);
            La[e].pos = B[0] + "x" + B[1];
            La[e].size = B[2] + "x" + B[3];
            a.id && "string" == typeof a.id &&
                (b |= 32);
            (k = v.calcTextChecksum(a)) && (b |= 16);
            var F = v.calcAttribChecksum(a);
            F && (c |= 2);
            a: {
                var z = v.getElementChildren(v.getElementParent(a), a.tagName);
                for (var H = 0; H < z.length; H++)
                    if ((!z[H].id || "string" != typeof z[H].id) && v.calcAttribChecksum(z[H]) == F && v.calcTextChecksum(z[H]) == k) {
                        z = !0;
                        break a
                    }
                z = !1
            ...
            if (z) {
                b |= 1;
                var h = v.calcChildrenChecksum(a)
            }
            z = [];
        ...
        function Ua(a) {
            ...
            for (var k = -1, d = a.form.elements, g = d.length, f = 0, q = 0; f < g; f++)
                if (d[f].name ==
                    a.name) {
                    if (d[f] == a) {
                        k = q;
        ...
        function G(a, e) {
            ...
            if (0 > b) return null;
            for (var c = e.elements, k = c.length, d = [], g = 0; g < k; g++)
                if (!v.isEmptyField(c[g])) {
                    var f = c[g][X];
                    f && 0 < f && h.mergeArrays(d, [f])
                }
            c = [];
            ...
            if (e && "SCROLLBAR" != e.nodeName) {
                if (/^INPUT|SELECT|TEXTAREA|BUTTON$/.test(e.tagName))
                    if (e[X]) u(e);
                        ...
                        if (b) {
                            b = b.elements;
                            for (var c = b.length, k = 0; k < c; k++) /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[k].tagName) && !b[k][X] && u(b[k])
                        } else u(e)
                    }
                else u(e);
                ba(q, [x.nowEventTime(), a.type, e, U.getPos(a), a.which, a.button])
            }
        }
        ...
        function na(a) {
            ...
            var e = "password" === a.type || sa.test(a.name) ||
                sa.test(a.id),
                b = h.reduce(function(e, b) {
                    return e || da.generalRegex.test(a[b])
                }, !1, ["className", "id", "name"]) || da.placeholderRegex.test(a.placeholder),
                c = da.forceRecordRegex.test(a.className);
            return {
                forceRecord: c,
                ignore: e,
                isPrivate: b,
        ...
        function Ga(a) {
            return "INPUT" == a.tagName ? "password" == a.type || a.name && sa.test(a.name) || a.id && sa.test(a.id) : !1
        }

        function E(a, e, b) {
            a = U.getTarget(a);
            var c = na(a);
            c.ignore || !c.forceRecord && (c.isPrivate && f.get("isEU") ||
                ra(a)) || (u(a), ba(k, [x.nowEventTime(), e, b, a, c.privateFlag]))
        }
        ...
        function P(a) {
            ...
            if ({
                    ...
                    144: 1,
                    145: 1
                }[e] || 112 <= e && 123 >= e || 96 <= e && 105 >= e || b & 16) 19 == e && 4 == (b & -17) && (e = 144), E(a, e, b | 16), Ha = !1, h.setTimeout(function() {
                Ha = !0
            }, 1, "fvl.keyDown"), !(67 == e && b & 4) || b & 1 || b & 2 || V()
        }

        function fa(a) {
            Ha && !oa && 0 !== a.which && (E(a, a.charCode || a.keyCode, sb(a)), oa = !0, h.setTimeout(function() {
                oa = !1
            }, 1, "fvl.keyPress"))
        }
        ...
        function ca() {
            ...
            if ("string" == typeof b) {
                ...
                if (c) {
                    a = na(c).privateFlag || ra(c, !0);
                    c = c.getElementsByTagName("*");
                    for (var k = 0; k < c.length && !a;) a = na(c[k]).privateFlag || ra(c[k], !0), k++;
                    b != gb && (gb = b, b = a ? h.map(function() {
                            return da.obfuscatedSymbol
                        },
                        b.split("")).join("") : b, ba(e, [x.nowEventTime(), b]))
                }
            }
        }

        function V() {
            Aa || (Aa = !0, gb && ba(B, [x.nowEventTime()]), h.setTimeout(function() {
                Aa = !1
            }, 1, "fvl.copy"))
        }

        function Q() {
            ta || (ta = !0, ba(H, [x.nowEventTime()]))
        }

        function C() {
            ta && (ta = !1, ba(z, [x.nowEventTime()]))
        }

        function D(a) {
            (!ta || a && !a.fromElement) && Q()
        }
        ...
        function R(a) {
            if ((a = U.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName)) {
                if (a[X]) u(a);
                else {
                    var e = a.form;
                    if (e) {
                ...
                ba(Z, [x.nowEventTime(), a])
            }
        }

        function K(a) {
            (a = U.getTarget(a)) && /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(a.tagName) && (u(a), ba(Ta, [x.nowEventTime(), a]))
        }

        function L(a) {
            if ((a = U.getTarget(a)) && !Ga(a) && !ra(a) && /^INPUT|SELECT|TEXTAREA$/.test(a.tagName)) {
                var e = na(a),
                ...
                u(a);
                ba(Ma, [x.nowEventTime(), a, b, e.privateFlag])
            }
        }
        ...
        function J(a) {
            if ((a = U.getTarget(a)) &&
                !A(a) && "FORM" == a.nodeName) {
                for (var e = a.elements, b = 0; b < e.length; b++) v.isEmptyField(e[b]) || u(e[b]);
                ba(G, [x.nowEventTime(), a], !0)
            }
        }

        function N(a) {
            (a = U.getTarget(a)) && "BODY" == a.tagName && O.append([], !0)
        }
        var O = new tb({
                protocol: a,
                counterId: b,
        ...
        x.initCorrector();
        x.nowTime();
        var X = "metrikaId_" + Math.random(),
            La = {},
            Va = ":submit" + Math.random();
        if (!h.isMetrikaPlayer()) {
            w.on(t, "click,dblclick,mousedown", ma);
            w.on(t, "mouseup", za);
            w.on(t, "keydown", P);
            w.on(t, "keypress", fa);
            w.on(t, "copy", V);
            if (v.getBody()) w.on(t, "mouseleave", N);
            t.attachEvent && !m.opera ? (w.on(t, "focusin", D), w.on(t,
                "focusout", I)) : (w.on(m, "focus", Q), w.on(m, "blur", C), w.on(t, "blur", C));
            t.addEventListener ? (w.on(t, "focus", R), w.on(t, "blur", K), w.on(t, "change", L), w.on(t, "submit", J)) : t.attachEvent && (w.on(t, "focusin", R), w.on(t, "focusout", K), function() {
                for (var a = t.getElementsByTagName("form"), e = 0; e < a.length; e++) {
                    for (var b = a[e].getElementsByTagName("*"), c = 0; c < b.length; c++)
                        if (/^INPUT|SELECT|TEXTAREA$/.test(b[c].tagName)) w.on(b[c], "change", L);
                    w.on(a[e], "submit", J)
                }
            }());
            (function() {
                ...
                if (a.length)
                    for (var e =
                            0; e < a.length; e++) {
                        var b = a[e].submit;
                        if ("function" == typeof b || "object" == typeof b && /^\s*function submit\(\)/.test(String(b))) a[e][Va] = b, a[e].submit = function() {
                            J({
                                target: this
                            });
                            return this[Va]()
        ...
        return {
            ...
            stop: function() {
                ...
                t.removeEventListener ?
                    (w.un(t, "focus", R), w.un(t, "blur", K), w.un(t, "change", L), w.un(t, "submit", J)) : t.detachEvent && (w.un(t, "focusin", R), w.un(t, "focusout", K), function() {
                        for (var a = t.getElementsByTagName("form"), e = 0; e < a.length; e++) {
                            for (var b = a[e].getElementsByTagName("*"), c = 0; c < b.length; c++) /^INPUT|SELECT|TEXTAREA$/.test(b[c].tagName) && w.un(b[c], "change", L);
                            w.un(a[e], "submit", J)
                        }
                    }());
                (function() {
                    for (var a = t.getElementsByTagName("form"), e = 0; e < a.length; e++) a[e][Va] && (a[e].submit = a[e][Va])
                })()
            }
        }
    }
    ...
    function pa() {
        return 0 == M().hostname.search(/^(.*\.)?((yandex(-team)?)\.(com?\.)?[a-z]+|(auto|kinopoisk|beru|bringly)\.ru|ya\.(ru|cc)|yadi\.sk|yastatic\.net|.*\.yandex|turbopages\.org|turbo\.site)$/)
    }
    ...
    function Yb() {
        var a = m.performance && m.performance.getEntriesByType,
            b = a ? h.filter(Xb, m.performance.getEntriesByType("paint")) : [];
    ...
    var Pa = !1,
        xb = "undefined" !== typeof Object && "function" === typeof Object.defineProperty;
    try {
        if (xb) var Zb = function(a) {
            function b(d) {
            ...
            return b(b.s = 65)
                    ...
                    F = {
                        binarySearch: function(a, b, e) {
                            ...
                            for (e = "function" === typeof e ? e : function(a) {
                                ...
                                var d = Math.round((c + k) /
                                        2),
                                    g = e(a[d]);
                                if (g === b) {
                                    var f = a[d];
                                    break
                                } else b > g ? c = d + 1 : k = d - 1
                            }
                            return f
                        },
                        forof: function(a, b) {
                        ...
                        toArray: function(a) {
                            return a instanceof g.List || a instanceof n.KeyValue ? p && a instanceof p || y && a instanceof y ? Object(l.a)(a) : a.toArray() : Object(l.a)(a)
                        },
                        toList: function(a) {
                        ...
                        addToArray: function(a) {
                            for (var b, e = arguments.length, c = Array(1 < e ? e - 1 : 0), d = 1; d < e; d++) c[d - 1] = arguments[d];
                ...
                var d = c.n(a),
                    ...
                    l = f.a.Object.assign || function(a) {
                        for (var b = 1; b < arguments.length; b++) {
                            var c = arguments[b],
                                d = f.a.Object.prototype.hasOwnProperty.bind(c),
                                g;
                            for (g in c) d(g) && (a[g] = c[g])
                        }
                        return a
                    },
                    g = c(20);
                ...
                var n = {
                    ...
                    isMonkeyPatchedOrUndefined: function(a, b) {
                        ...
                        if (b)
                            for (var d = 0; d < b.length; d++)
                                if (!this.isNative(c[a].prototype[b[d]], b[d])) return !0;
                        return !1
                    },
                    ...
                    safeAccess: function(a, b) {
                        ...
                        for (var c = b.split("."), d = a, g = 0, k = c.length; g < k; g++)
                            if (d = d[c[g]], null == d) return A;
                        return d
                    },
                ...
                var y = function() {
                    ...
                    F = ["%cWV:", "font-weight: bold;"];
                c && F.length && (F[1] += "color: purple");
                Object(a.a)(r, function(a) {
                    var b, e = r[a] instanceof n.a.Function;
                    p[a] = y ? e ? (b = r[a]).bind.apply(b, [r].concat(F)) : r[a] : e ? function() {} : r[a]
                }, !0);
                y && (p.devLog = r.log);
                b["default"] = p
            }, function(a, b, c) {
                ...
                b.a = function() {
                    ...
                    if ("undefined" !== typeof t && t.body) {
                        ...
                        b.contentWindow && (b.contentWindow.toJSON = function() {
                            return A
                        });
                        try {
                    ...
                    n = {
                        ...
                        getScroll: function(a) {
                            ...
                            var b = a.ownerDocument || a,
                                c = a.documentElement,
                                d = b.defaultView || b.parentWindow,
                                g = b.body;
                            a === b && (a = this.scrollingElement(b));
                            return -1 !== [c, g].indexOf(a) ? {
                                top: a.scrollTop || d.scrollY,
                                left: a.scrollLeft || d.scrollX
                            } : {
                                top: a.scrollTop || 0,
                                left: a.scrollLeft || 0
                            }
                        ...
                        scrollingElement: function(a) {
                            a = a || t;
                            return a.scrollingElement || (a.documentElement.scrollHeight >= a.body.scrollHeight && 0 === a.compatMode.indexOf("CSS1") ? a.documentElement :
                                a.body)
                        },
                        convertNode: function(a, b, c) {
                            ...
                            d && f.IterableUtils.forof(a.childNodes, function(a) {
                        ...
                        isBlankOrSameOriginIframe: function(a, b) {
                            ...
                            return d && !d.match(/allow-same-origin/) || c && "about:blank" !== c && (c = g.StringUtils.parseURLNative(c).host) &&
                                (b || m).location.host !== c ? !1 : !0
                        },
                        ...
                        contentSizeChanged: function(a, b) {
                            var c = a.ownerDocument ? a.ownerDocument.defaultView : m,
                                d = {
                                    ...
                                    runner: function() {
                                        if (!this.stopped) {
                                            var d = null == a ? {} : "function" === typeof a ? a() || {} :
                                                a;
                                            var k = d.scrollHeight;
                                            d = d.scrollWidth;
                                            if (k !== this.height || d !== this.width) this.height = k, this.width = d, b({
                                                width: d,
                                                height: k
                                            });
                        ...
                        elementsFromPoint: function(a, b, c) {
                            c = c || t;
                            var d = c.elementsFromPoint;
                            if (d) return d.call(c, a, b);
                            d = [];
                            for (var g = [], k;
                                (k = c.elementFromPoint(a, b)) && -1 === d.indexOf(k);) {
                                d.push(k);
                                var e = k.style;
                                g.push({
                            ...
                            for (a = g.length; b = g[--a];) d[a].style.setProperty("pointer-events", b.value ? b.value : "", b.priority);
                            return d
                        },
                        ...
                        offsets: function(a, b) {
                            ...
                            if (g || k) {
                                ...
                                k && (k = e.paddingRight, g = e.paddingBottom, r = e.paddingLeft, c += parseInt(e.paddingTop || "0", 10), d += parseInt(k || "0", 10), l += parseInt(g || "0", 10), f += parseInt(r || "0", 10))
                            }
                            return {
                                top: c,
                                right: d,
                        ...
                        waitForNode: function(a, b, c) {
                            ...
                            if (d.nodeIsInTree(a)) b(!0);
                            else {
                                var k = a.ownerDocument || t,
                                    e = new MutationObserver(function() {
                                        d.nodeIsInTree(a) && (b(!0), e.disconnect())
                                    });
                                e.observe(k.documentElement, {
                                    subtree: !0,
                                    childList: !0
                                });
                                var f = isFinite(c) ? I(function() {
                                    d.nodeIsInTree(a) || (b(!1), e.disconnect())
                                }, c) : A;
                        ...
                        createElement: function(a, b, c) {
                            ...
                            f.IterableUtils.forin(b, function(a) {
                                var c = b[a];
                                "style" === a ? l.ObjectUtils.assign(d[a], c) : d[a] = c
                            });
                            return d
                        },
                ...
                var p = c.IGNORED_NODES,
                    ...
                    h = function na(a, b) {
                        ...
                        if (a.childNodes && 0 < a.childNodes.length) {
                            c = a.childNodes;
                            for (var k = 0, d = c.length; k < d; k++) e.push.apply(e, na(c[k]))
                        }
                        return e
                    },
                    m = function(a, b, e) {
                    ...
                    Na = function(a) {
                        ...
                        g.IterableUtils.forin(e, function(a) {
                            var k, d = (k = []).concat.apply(k, e[a].concat(b));
                            c[a] = new RegExp(d.join("|"), "i")
                        });
                        return function(a, b) {
                            if (a && b) {
                                var e = "string" ===
                        ...
                        if (G(a, b, c)) {
                            k = e.reduce(function(e, c) {
                                try {
                                    ...
                                    return y["default"].warn("Filtering error",
                                        ca), e
                                }
                            }, k);
                    ...
                    v = function(a, b, e) {
                        if (e && e.name) {
                            if (!1 !== u(b, e.name)) try {
                                var c, k = ba(a, e.name, e.value);
                                return c = {}, c[e.name] = k || "", c
                            } catch (P) {
                                y["default"].warn("Error while reading attribute", e, a), y["default"].warn(P)
                            }
                        } else y["default"].warn("Error while reading attribute", e, a);
                        return null
                    };
                c = function(a) {
                    var b =
                ...
                c = {
                    ...
                    walk: m,
                    each: function(a, b, e) {
                        a && (a = Ma(a, e), g.IterableUtils.fastIterate(a, b))
                    },
                    ...
                    getNamespace: function(a) {
                        if (w(a)) return a.namespaceURI
                    },
                    normalizeAttributeValue: ba,
                    ...
                    var d = c(8),
                        ...
                        r = function() {
                            ...
                            c._saveEvent = function(a, b) {
                                ...
                                e = f[0];
                                f = f[1];
                                var l = this._events.get(e) || new d["default"];
                                c = this._options.get(e) || g.IterableUtils.toList(c);
                                var q = this._memory.get(e) || !1;
                                l.has(b) ||
                                    (l.add(b), this._events.set(e, l), this._options.set(e, c), this._saveNamespace(e, f, b), q && this._runCallback(e, b, q))
                            };
                ...
                var n = new RegExp("(" + c.join("|") + ")", "i"),
                    r = new RegExp("(" + c.concat(a).join("|") +
                        ")", "i"),
                    y = /color|radio|checkbox|date|datetime-local|email|month|number|password|range|search|tel|text|time|url|week/i,
                    p = {
                        ...
                        validate: function(a, b) {
                            var c = b || {},
                                e = c.isEU,
                                d = c.recording.keysMode;
                            c = p.isRecordable(a);
                            var g = p.isPrivateInformationField(a);
                            e = p.isAllowed(a, "explicit" === d) && (!e || !g);
                            return {
                                forceRecord: c,
                                isPrivate: g,
                                isAllowed: e
                    ...
                    l = {
                        dasherize: function(a) {
                            return a.replace(/[A-Z]/g, function(b,
                                c) {
                                var d = /[A-Z]/g.test(a[c - 1]);
                                return (0 === c || d ? "" : "-") + b.toLowerCase()
                            })
                        },
                        ...
                        create: function(a, b) {
                            ...
                            g = {
                                ...
                                run: function(b) {
                                    ...
                                    n && (clearTimeout(h), h = I(function() {
                                        return q = !0
                                    }, l));
                                    if (!z) {
                                        k = b;
                                        for (var g = arguments.length, f = Array(1 < g ? g - 1 : 0), r = 1; r < g; r++) f[r - 1] = arguments[r];
                                        m = f;
                                        q && n ?
                                            (q = !1, B = b, a.call(d, {
                                                object: b,
                                                ...
                                                timeDifff: 0,
                                                args: m
                                            })) : (H = c.now(), z = !0, I(function ra() {
                                                var b = parseInt(c.now() - H, 10);
                                                b >= l ? (z = !1, H = c.now(), B !== k && (e = B, B = k, a.call(d, {
                                                    object: k,
                                                    prevObject: e,
                                                    timeDiff: b,
                                                    args: m
                ...
                var d = {
                    ...
                    lazy: function(a, b) {
                        ...
                        var c;
                        return function() {
                            for (var d = arguments.length, g = Array(d), f = 0; f < d; f++) g[f] = arguments[f];
                            clearTimeout(c);
                            c = I(function() {
                                a.apply(void 0, g)
                            }, b)
                    ...
                    repeat: function(a, b) {
                        ...
                        var h = Date.now(),
                            q = !1,
                            k = null,
                            e = c ? this.requestAnimationFrame.bind(this) : I,
                            B = c ? this.cancelAnimationFrame.bind(this) : clearTimeout;
                        c = function z() {
                            q ? B(k) :
                                (Date.now() - h >= p && (h = Date.now(), a.apply(f, l)), k = e(z))
                        };
                        c.stop = function() {
                            q = !0
                        };
                ...
                var d = c(4),
                    ...
                    g = function(a, b,
                        ...
                        void 0 === g && (g = {});
                        a += "EventListener";
                        if (b && b[a]) return l ? b[a](c, d, g) : b[a](c, d, "boolean" === typeof g ? g : g.capture || !1)
                    };
                a = function() {
                    function a() {}
                    ...
                    b.a = function(b) {
                        ...
                        try {
                            if (b.forEach) b.forEach(function(a, b) {
                                ...
                                for (var p = b[a.iterator](), h, q; h = p.next(), q = h.value, !h.done;) c.push(q);
                            return c
                        } catch (k) {
                            return []
                        }
                ...
                (function(a) {
                    ...
                    b.a = function(b, c) {
                        ...
                        if (b && c instanceof Function)
                            ...
                            for (f = Object(d.a)(b), n = 0; n < f.length && (h = f[n], h = g ? c.apply(void 0, h) : c(h), !0 === h || !1 !== h); n++);
                    }
                }).call(this, c(25)["default"])
            }, function(a, b, c) {
                (function(a, f, l) {
                    ...
                    var n = c(15),
                        ...
                        p = new a,
                        h = HTMLCanvasElement.prototype.getContext,
                        q = function(a) {
                    ...
                    a = function() {
                        ...
                        a.mock = function() {
                            if (!this.mocked) {
                                ...
                                HTMLCanvasElement.prototype.getContext = function(b) {
                                    var c = h.call(this, b);
                                    if (null !== c) return !1 !== this.proxy && 0 <= y.indexOf(b) && a.update(c), c
                                };
                        ...
                        a.remove = function() {
                            this.mocked && (this.mocked = !1, this.events.off(), HTMLCanvasElement.prototype.getContext = h)
                        };
                        a.update = function(b) {
                            if (!1 === a.proxies.has(b)) {
                                ...
                                f.nodeIsRecordable(e) && g.properties && (f.forof(g.properties,
                                    function(a) {
                                        ...
                                        e.set && (k.set = function(d) {
                                            c.setterInvoked(b, a, d);
                                            return e.set.call(b, d)
                                        });
                                    ...
                                    Object.defineProperty(b, a, {
                                        configurable: !0,
                                        value: function() {
                                            for (var d = arguments.length, k = Array(d), g = 0; g < d; g++) k[g] = arguments[g];
                                            c.methodInvoked(b, a, k);
                                            return e.bind.apply(e, [b].concat(k))
                                        }
                                    })
                                }));
                                a.proxies.add(b)
                    ...
                    d = function() {
                        ...
                        c._executeJob = function(a) {
                            ...
                            try {
                                ...
                                n["default"].log("Error occurred when running job"), n["default"].log(F), n["default"].log(a.toString())
                            }
                ...
                (function(b) {
                    function c(a, c, d, f, y, p, h) {
                        ...
                        g.done ? c(k) : b.resolve(k).then(f, y)
                    }
                    a.exports = function(a) {
                        return function() {
                            var d = this,
                        ...
                        return {
                            ...
                            handleNodeIndex: function(a) {
                                if (n.a.isValidNode(a.nativeNode) && "__ym_input_override_test" !== a.nativeNode.getAttribute("class")) {
                                    var b =
                                        a.nativeNode,
                                        c = a.id,
                                        d = "radio" === a.attributes.type || "checkbox" === a.attributes.type;
                                    a = this.getPropertyName(d);
                                    this.inputs[c] = {
                                        checkable: d,
                                        value: b[a]
                                    };
                                    d = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(b), a) || {};
                                    var e = Object.getOwnPropertyDescriptor(b, a) || {},
                                        B = g()({}, d, e);
                                    if (f.isNative(B.set, "((set)?(\\s?" + a + ")?)?")) {
                                        var l = this;
                                        try {
                                            Object.defineProperty(b, a, g()({}, B, {
                                                configurable: !0,
                                                set: function(a) {
                                                    var b = this;
                            ...
                            handleInputChangeValueEvent: function(a) {
                                ...
                                this.recorder.errorLogger(function() {
                                    var c = a.target,
                                        d = b.recorder.indexer.get(c);
                                    if (d) {
                                        var e = d.id;
                                        if (!b.inputs[e] && (b.handleNodeIndex(d), !b.inputs[e])) return;
                                        d = b.getPropertyName(b.inputs[e].checkable);
                                        b.handleInputValueChange(e, c[d], c)
                                    }
                                }, "inpChV")
                            },
                            handleInputValueChange: function(a, b, c) {
                                var d = this.inputs[a],
                                    e = d.checkable;
                                d = d.value;
                                if ((!b || -1 !== ["string", "boolean", "number"].indexOf(typeof b)) && b !== d) {
                                    if (e) c =
                                        this.recorder._getEventObject("change", a, {
                                            checked: !!b
                                        });
                                    else {
                                        var g = n.a.validate(c, this.recorder.options);
                                        d = g.forceRecord;
                                        var f = g.isPrivate;
                                        g = g.isAllowed || d ? b : n.a.encode(b);
                            ...
                            checkInpudDescriptorOverrideAbility: function(a) {
                                ...
                                try {
                                    ...
                                    var d = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(c), "value") || {},
                                        e = Object.getOwnPropertyDescriptor(c, "value") || {},
                                        f = g()({}, d, e);
                                    Object.defineProperty(c, "value", g()({}, f, {
                                        configurable: !0,
                                        set: function(a) {
                                            return f.set.call(c,
                                                a)
                            ...
                            destroy: function(a) {
                                ...
                                Object.keys(this.inputs).forEach(function(c) {
                                    var d = a.indexer.findByID(c);
                                    if (d) {
                                        c = b.getPropertyName(b.inputs[c].checkable);
                                        var e = Object.getOwnPropertyDescriptor(Object.getPrototypeOf(d), c);
                ...
                (function(a, f) {
                    ...
                    b.a = function() {
                        var b = {
                            ...
                            p = function(a) {
                                var b = this.stamp;
                                "mousemove" === a.type ? y.call(this, a, b) : l.call(this, {
                                    object: a,
                                    args: [b]
                                })
                            };
                    ...
                    b.a = function() {
                        var b = {
                            ...
                            k = function(a) {
                                ...
                                "touchmove" === a.type ? h ? F.call(this, {
                                        object: a,
                                        args: [b]
                                    }) : q.call(this, a, b) :
                                    F.call(this, {
                        ...
                        return {
                            create: function(a) {
                                ...
                                l.forin(b, function(d) {
                                    c.add(a.attachEvent(a.document, d, e, b[d]))
                                });
                                var d = null,
                                    f = a._universalHandler(function() {
                                        clearTimeout(d);
                                        h = !0;
                                        d = I(function() {
                                            return h = !1
                                ...
                                c.add(a.attachEvent(a.document, "scroll", f, {
                                    passive: !0,
                                    capture: !0
                                }))
                            },
                ...
                (function(a, c) {
                    b.a = function() {
                        ...
                        return {
                            create: function(a) {
                                var b = a._universalHandler(h);
                                c.forin(f, function(c) {
                                    y.add(a.attachEvent(a.window, c, b, f[c]))
                                })
                            },
                            destroy: function(a) {
                                c.forof(y, function(b) {
                                    return a.removeEvent(b)
                                });
                                y.clear()
                            }
                ...
                (function(a) {
                    ...
                    d = function(b) {
                        function c(c, e, d) {
                            ...
                            r()(g()(k), "IGNORE_NODE_ATTRIBUTE", "__ym_wv_ign");
                            r()(g()(k), "eventsList", ["mutation"]);
                            k.indexer = e;
                            k.originalHTML = k.indexer.html;
                            k.target = c;
                            k.watcher = new y.a(k.target, d);
                            k.queue = new h.a;
                            k._timer = a.timer();
                            k.watcher.on("mutation", k.collectMutations.bind(g()(k)));
                            return k
                        }
                        n()(c, b);
                        var e = c.prototype;
                        e.addChanges = function(b, c) {
                            for (var e = arguments.length, d = Array(2 < e ? e - 2 : 0), k = 2; k < e; k++) d[k - 2] = arguments[k];
                            if (null != b[c] && 0 < d.length) {
                                var f, g = b[c].length;
                                a.fastIterate(d, function(a, b) {
                                    return b.i = g + a
                                });
                                b[c] = (f = b[c]).concat.apply(f, d)
                            }
                        };
                        ...
                        e.processMutations = function(b) {
                            ...
                            a.fastIterate(b, function(a, b) {
                                if (b.target.parentNode && !m.c.isIgnoredNode(b.target.parentNode)) {
                                    var k = c.changesObject;
                                    !1 !== function() {
                                        var a = b.type,
                                            e = b.target,
                                            d = c.indexer.getIndexedNodeId(e);
                                        if (null == d) return !1;
                                        e = [b, d, e, k];
                                        switch (a) {
                                            case "childList":
                                    ...
                                    }() && (e = !0, d.push(c.cleanChangesObject(k)))
                                }
                            });
                            return {
                                store: d,
                        ...
                        e.processTreeChanges = function(b, c, e, d) {
                            var k = this,
                                f = b.nextSibling,
                                g = b.previousSibling;
                            e = b.meta;
                                ...
                                k.indexer.reindexNodeTree(e, {
                                    ...
                                    callback: function(b, c) {
                                        if (b) {
                                            ...
                                            b.content && (d.ct = b.content);
                                            b.namespace && (d.ns = b.namespace);
                                            d.at = m.c.getAttributes(b.nativeNode);
                                            l.push(d)
                                        }
                                    }
                                })
                            ...
                            this.addChanges.apply(this, [d, "a"].concat(B));
                            this.addChanges.apply(this, [d, "b"].concat(l))
                        };
                ...
                (function(a, f, l) {
                    ...
                    d = function(b) {
                        ...
                        d.initMutationObserver = function() {
                            var b = this,
                        ...
                        d.collectSummary = function(a, b, c, d) {
                            switch (a) {
                                case "childList":
                                    b = f.reduce(d.addedNodes, function(a, b) {
                                        !1 === c.added.has(b) && (a.push(b), h.c.walk(b, function(a) {
                                            c.removed.has(a) &&
                                                c.removed["delete"](a);
                                    ...
                                    d = f.reduce(d.removedNodes, function(a, b) {
                                        !1 === c.removed.has(b) && (a.push(b), h.c.walk(b, function(a) {
                                ...
                                case "attributes":
                                    ...
                                    if (d !== e) return {
                                        name: a,
                                        oldValue: h.c.normalizeAttributeValue(b, a, d),
                                        newValue: h.c.normalizeAttributeValue(b, a, e)
                                    };
                                    break;
                                case "characterData":
                                    if (d = d.oldValue, b = b.textContent,
                                        b !== d) return {
                                        oldValue: d,
                                        newValue: b
                                    }
                ...
                a = function() {
                    ...
                    b.cancelCapture = function() {
                        this.isModifierPressed() ? I(this.cancelCapture.bind(this), 100) : this.keyStroke.length = 0
                    };
                    b.reset = function() {
                        var a =
                            this;
                        this._reset = I(function() {
                            a.resetImmediate()
                        }, 300)
                    };
                    ...
                    var F = {},
                        ...
                        k = function() {
                            function b() {
                                ...
                                r.ObjectUtils.assign(F, h.Tools.apiMock(HTMLMediaElement))
                            }
                            var c = b.prototype;
                            ...
                            c.mock = function() {
                                var a = this,
                                    ...
                                    c = this;
                                p.IterableUtils.forof(F.properties, function(e) {
                                    if (q.has(e)) return !0;
                                    var d = a.descriptor(b, e);
                                    if (d) {
                                        a.originalDescriptors.set(e, d);
                                        var k = r.ObjectUtils.combine(d);
                                        ...
                                        Object.defineProperty(b, e, k)
                                    }
                                });
                                p.IterableUtils.forof(F.methods, function(e) {
                                    if (q.has(e)) return !0;
                                    var d = a.descriptor(b, e);
                                    a.originalDescriptors.set(e, d);
                                    Object.defineProperty(b, e, {
                                        configurable: !0,
                                        value: function() {
                                            for (var a, b = arguments.length, k = Array(b), f = 0; f < b; f++) k[f] = arguments[f];
                                            c.methodInvoked(this, e, k);
                ...
                (function(a) {
                    ...
                    var d = function(b, c) {
                        void 0 === c && (c = "body");
                        return new a(function(a) {
                            null == b.querySelector(c) || t.hidden || t.msHidden || t.webkitHidden ? function y() {
                                null == b.querySelector(c) || t.hidden || t.msHidden || t.webkitHidden ? I(y, 100) : a()
                            }() : a()
                        })
                    }
                }).call(this,
                    ...
                    d = function(b) {
                            ...
                            if (a = this.middleware.run(a)) {
                                ...
                                if (!1 === this.dom.has(a) || null == e) {
                                    ...
                                    e = {
                                        ...
                                        parent: b,
                                        nativeNode: a,
                                        namespace: m.c.getNamespace(a),
                                        attributes: m.c.getAttributes(a),
                                        content: m.c.getContent(a)
                                    };
                                    this.recorder && "INPUT" ===
                                        d && (b = Z.a.validate(a, this.recorder.options), d = b.forceRecord, b = !b.isAllowed && !d, d = e.attributes.value, e.attributes.value = b ? Z.a.encode(d) : d, b && (e.hidden = !0));
                        ...
                        d.reindexNodeTree = function(a, b) {
                            ...
                            var k = e.callback,
                                f = void 0 === k ? null : k;
                            e = e.parentID;
                            var g = void 0 === e ? null : e;
                            if (a) {
                                var l = [];
                                if (a.parentNode || g) f = B.FunctionUtils.toFunction(f), m.c.each(a, function(a, b) {
                                    g = b.parentNode && c.getNodeId(b.parentNode) || g;
                                    if (null != g) {
                                        var e = c.addToIndex(b, g);
                                        l.push(e);
                                        f(e, b)
                                    }
                                });
                        ...
                        d.showMissingNodes = function(a) {
                            ...
                            a && H.Tools.measure("Show missing nodes", function() {
                                var a = m.c.all(b.document.documentElement);
                    ...
                    d = function() {
                        ...
                        c.send = function(a, b) {
                            var c = this,
                                ...
                                m, F = [],
                                t = Date.now();
                            "function" === typeof f && (y = !0, h = a + "." + this.timestamp, this.listenOnce(function(a) {
                                var b = a.data,
                                    e = b._ym_cancel_response,
                                    d = b.data;
                                if (b.type === h) e ? r["default"].warn("Seems like you forgot to call `answer` in a message handler. This message requires response.") :
                                    (p = !0, f(d, {
                                        origin: a.origin,
                            ...
                            (function za() {
                                ...
                                if (q && y) {
                                    ...
                                    void 0 === b && (b = 3E4);
                                    b = Date.now() - t >= b;
                                    !1 === p && (b ? "function" === typeof g && g() : m = I(za, 100))
                                }
                            })()
                        };
                            ...
                            if (null == this._cancelMainHandler) {
                                var b = this._attachEvent("message", function(b) {
                                    var c = b.data || {},
                                        ...
                                        k = c.data,
                                        f = c.type;
                                    if (!0 === c._ym_messenger && f && !/\.([0-9]+)$/.test(f)) {
                                        c = a._getSubcribers(f) || [];
                                        var g = a._findIframe(b.source, d);
                                        if (null === g) r["default"].warn("Cannot find iframe with id " + d);
                                        else {
                                            var q = {
                                                id: d,
                                                sender: g,
                    ...
                    var g = c(0),
                        ...
                        h = {
                            items: {
                                ...
                                cssURLFinderNoParenthesis: /url\((?!#|data|blob|'|")([^'"\(\)]+)\)/g,
                        ...
                        k = function(a) {
                            return "string" ===
                                typeof a ? URL.parse ? URL.parse(a) : new URL(a) : a
                        },
                        e = function(a) {
                            return q.get(a) || a
                        },
                    ...
                    d = Object.defineProperties({
                        ...
                        patchCSS: function(a, b) {
                            var c = this,
                                ...
                                d = void 0 === e ? null : e;
                            e = ["cssURLFinder", "URLImportFinder",
                                "cssURLFinderNoParenthesis"
                            ];
                            var k = {
                                cssURLFinderNoParenthesis: function(a) {
                                    return "url('" + a + "')"
                                },
                            ...
                            return e.reduce(function(a, b) {
                                return c.patchURLS(a, h.get(b), d, k[b])
                            }, a)
                        },
                        patchURLS: function(a, b, c, e) {
                            ...
                            "string" === typeof a && a.match(b) && (k = a.replace(b, function() {
                                var a = d.patchURL(1 >=
                                    arguments.length ? A : arguments[1], {
                                        location: c
                                    });
                                return f(a)
                            }));
                        ...
                        applyPatch: function(b, c) {
                            ...
                            d = b;
                            h.resetAll();
                            if (h.test("dataurlTest", b) || h.test("selectorTest", b)) return b;
                            h.test("protocolMissing", b) && (d = h.test("protocolIncomplete", b) ? b.replace(h.get("protocolIncomplete"), f + "//") : f + "//" + (k + "/" + e).replace(/\/\/+/, "/"));
                            q.set(b, d);
                            /http[s]?/.test(d) ? (k = d, h.test("proxiedURL", k) ? d = k : (p.isWhitelisted ? (f = p.isWhitelisted(k)) && a.warn("Whitelisted: " + k) : f = !1, d = f ? k : (f = p.proxy) && h.test("resourceFinder",
                                f) ? f.replace(h.get("resourceFinder"), encodeURIComponent(k)) : k), H.push(d), F.set(b, d), k = d) : (H.push(b), F.set(b, d), k = b);
                            return p.noEncode ? decodeURIComponent(k) : k
                        },
                        getRelativeLocation: function(a) {
                            var b = h.test("relativePath", a);
                        ...
                        resolvePath: function(a,
                            ...
                            for (var c = (b.replace(/\/[^\/]*$/, "") + "/" + a).split("/"), e = [], d = 0, k = c.length; d < k; d++) {
                                var f = c[d];
                                "" === f ? e.length = 0 : "." !== f && (".." === f ? 0 < e.length && --e.length : e.push(f))
                            }
                            e.unshift("");
                            return e.join("/")
                        },
                        ...
                        isURLLike: function(a) {
                            h.resetMultiple(["dataurlTest", "selectorTest", "extnameFinder", "protocolMissing"]);
                            return h.test("dataurlTest", a) || h.test("selectorTest", a) ? !1 : h.test("extnameFinder", a) && h.test("protocolMissing", a)
                        },
                        clearCache: function() {
                            F.clear();
                            q.clear()
                        ...
                        isProxiedURL: function(a) {
                            return a ? h.test("proxiedURL", a) : !1
                        }
                    }, {
                        location: {
                            get: function() {
                ...
                b.a = {
                        ...
                        return {
                            create: function(a) {
                                a.keyCapture.onCapture(function(b) {
                                    "OBJECT" === t.activeElement.nodeName && /flash/.test(t.getAttribute("type")) || (b = a._getEventObject("keystroke", -1, b), a._publishActions(b))
                                })
                            },
                            destroy: function(a) {
                            ...
                            create: function(a) {
                                var b = new a.MediaProxy,
                                    ...
                                    e = a._universalHandler(function(b) {
                                        b =
                                            a._getEventObject("mediaMethod", b.media, {
                                                method: b.name,
                                                args: b.args
                                            });
                                        a._publishActions(b)
                        ...
                        var a = new d.a,
                            ...
                            e = function(e) {
                                ...
                                a.push(function() {
                                    k !== b && (c = 0);
                                    b = k;
                                    d._publishMutations(d._getMutationObject(f, k, c++))
                                })
                            };
                        return {
                            create: function(a) {
                    ...
                    resize: function() {
                        var a, b = function(a, b) {
                            var c = 0,
                                e = function() {
                                    var d = b.getValue.call(this, a);
                                    d && (0 !== d.stamp ? this._publishActions(d) : 3 > c && (I(e, 300), c += 1))
                                }.bind(this);
                            e()
                        };
                        return {
            ...
            function(a, b, c) {
                ...
                var d = c(12),
                    ...
                    h = function(a, b) {
                        ...
                        a.attributes && (f.DOMUtils.copyAttributes(a, c), c.className = a.className);
                    ...
                    if (0 <= g.indexOf(a.nodeName)) {
                        ...
                        if (b) {
                            ...
                            b = function(a) {
                                switch (c) {
                                    case "#text":
                                        var b = h(a, "span").placeholder;
                                        b.setAttribute("ym-text-content",
                                            l.randomizeString(a.textContent || ""));
                                        return b;
                                    case "IMG":
                                        return b = h(a, "img"), a = b.placeholder, b = b.bounds, a.src = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII\x3d", a.width = b.width, a.height = b.height, a;
                                    case "TEXTAREA":
                                    case "INPUT":
                                        return b = h(a, "input"), a = b.placeholder, b = b.bounds, a.style.width = b.width + "px", a.style.height = b.height + "px", a;
                                    default:
                                        return b = h(a, "span"), a = b.placeholder, b = b.bounds, a.style.width = b.width + "px", a.style.height =
                                            b.height + "px", a
                                }
                            }(a);
                            n.set(a, b);
            ...
            function(a, b, c) {
                ...
                (function(a, f, l) {
                    ...
                    var M = c(26),
                        ...
                        S = !0 === na.a,
                        O = ia.IS_INCOGNITO || ia.DO_NOT_TRACK || "disable" === ca.BrowserUtils.meta("webvisor"),
                        Fa = m !== m.top;
                    ...
                    var qa = function(b) {
                            function c(c, d) {
                                ...
                                e()(q()(k), "middlewares", []);
                                e()(q()(k), "options",
                                    ha.ObjectUtils.assign({}, U));
                                e()(q()(k), "initOptions", ha.ObjectUtils.assign({}, aa));
                                e()(q()(k), "iframes", []);
                                    ...
                                    return function(c, e) {
                                        ...
                                        try {
                                            var l = p()({}, k.options),
                                                ...
                                                h = f === l.counterId,
                                                n = B === m.location.host,
                                                q = -1 !== (l.trustedDomains || []).indexOf(B);
                                            n || q && h ? (k.offsets = d, k.sender.useRight(function(a) {
                                                var b = a.data,
                                                    c = {};
                                            ...
                                            })) : Y["default"].warn("Counter or domain mismatch, iframe will be recorded as master window");
                                            return a()
                                        } catch (Ub) {
                                            b(Ub)
                                        }
                                ...
                                k.sender = new x.a(k.middlewares.splice(0));
                                k.captors = new a;
                                k._timer =
                                    Q.TimeUtils.timer();
                                ...
                                return !S || O ? q()(k) || q()(k) : k
                            }
                            k()(c, b);
                            var d = c.prototype;
                            d.configure = function() {
                                var a = ha.ObjectUtils.combine({}, p()({}, U, this._configOptions));
                                this.frames = [];
                                ...
                                this.startOptions = this.initException =
                                    null;
                                this.precache = [];
                                this.options = p()({}, a);
                                this.canvasProxy = u.a;
                                this.MediaProxy = C.a;
                                P.c.addAttributesFilter(function(b, c, e) {
                                    if (G.a.isValidNode(b) && "value" === c) return b = G.a.validate(b, a), c = b.forceRecord, b.isAllowed || c ? e : G.a.encode(e);
                                    if ("checked" === c && ["INPUT", "CHECKBOX", "RADIO"].includes(b.nodeName)) return b.checked ? "checked" : null
                                })
                            };
                            ...
                            d.init = function(a) {
                                ...
                                this.errorLogger(y()(h.a.mark(function ta() {
                                    return h.a.wrap(function(a) {
                                        for (;;) switch (a.prev =
                                            ...
                                            case 2:
                                                return a.prev = 2, a.next = 5, Object(D.a)(b.document);
                                            case 5:
                            ...
                            d.__handleDocumentLoad = function() {
                                var a = y()(h.a.mark(function Aa() {
                                    var a = this;
                                    return h.a.wrap(function(b) {
                                        for (;;) switch (b.prev = b.next) {
                                            case 0:
                                                return this.configure(), this.__initIndexer(), this.__initEventHandlers(), b.next = 5, this._initMessenger();
                                            case 5:
                                                this.waitingDocument = !1, this.ableToStart = !0, this.cancelIfNotStarted = I(function() {
                                                        a.stop(!0, !1)
                                                    }, 3E4),
                                                    this.emit("ready"), this.inited = !0, this.startOptions && this.start(this.startOptions);
                                            case 11:
                                            case "end":
                                                return b.stop()
                                        }
                            ...
                            d.__initEventHandlers = function() {
                                this.summary =
                                    new w.a(this.document.documentElement, this.indexer, this);
                                this.selection = new N.a(m, this.document, this.indexer);
                            ...
                            d.connectSlaveRecorder = function(a) {
                                var b = this;
                                if ("IFRAME" === a.nodeName && a.name !== Z.a.NATIVE_IFRAME_NAME && V.DOMUtils.isBlankOrSameOriginIframe(a, this.window)) {
                                    try {
                                    ...
                                    var e = function fb(a) {
                                            var c = a.contentWindow,
                                                e = a.contentDocument;
                                            Y["default"].log("creating recorder");
                                            if (c && e) {
                                                if (!0 === c.__YM_WV_RECORDABLE__) return Y["default"].warn("Iframe has internal counter installed");
                                                if (!0 === c.__YM_RECORDING__) return Y["default"].warn("We're already recording this iframe", a);
                                                ...
                                                return Y["default"].info("Recorder injected into the iframe",
                                                    a)
                                            }
                                            I(function() {
                                                return fb(a)
                                        ...
                                        d = function(c) {
                                            b.errorLogger(function() {
                                                if (c && c.parentElement && c.contentDocument && V.DOMUtils.isBlankOrSameOriginIframe(a, b.window) && !0 !== c.contentWindow.__WV_ENABLED__) try {
                                                    e(c)
                                                } catch (fb) {
                                                    Y["default"].error(fb), Y["default"].warn("Probably this iframe is cross-origin")
                                                }
                                            }, "ifLo")
                                        };
                            ...
                            d.start = function(a) {
                                ...
                                this.errorLogger(function() {
                                    if (b.ableToStart)
                                        if (!1 === b.fatalError)
                                            if (!b.inited) b.savePageSnapshot(),
                                                b.fatal("init-failed", Error("Unknown error"));
                                            else {
                                                if (S && !O) {
                                                    clearTimeout(b.cancelIfNotStarted);
                                                    var c = (a || {}).forms;
                                                    b.options.recording = ha.ObjectUtils.combine({}, U.recording, {
                            ...
                            d.stop = function(a, b) {
                                ...
                                void 0 === a && (a = !1);
                                void 0 === b && (b = !0);
                                S && !O && (!1 !== this.started && this.inited || a) && !0 !== this.stopped && (clearTimeout(this.cancelIfNotStarted), clearTimeout(this.sendErrors), this.captors.forEach(function(a) {
                                    a && a.hasOwnProperty("destroy") && a.destroy(c)
                                }), this.indexer && this.indexer.clear(), this.captors && this.captors.clear(), Ga.a.invokeAll(this), this.summary && this.summary.destroy(), this.keyCapture && this.keyCapture.destroy(), b ? (this._sendEOF(), !0 === this.fatalError && this._sendPreCachedData({
                                    force: !0
                            ...
                            d._initCaptors = function() {
                                ...
                                var b = ha.ObjectUtils.combine({}, Z.a.captors, Fa ? Z.a.iframeCaptors : null);
                            ...
                            d._blockUpcomingCaptor = function(a, b) {
                                var c = this;
                                void 0 === b && (b = Infinity);
                                a && (this._blockedCaptors = this._blockedCaptors ||
                                    new l, this._blockedCaptors.add(a), Infinity > b && I(function() {
                            ...
                            d._initMessenger = function() {
                                ...
                                return new f(function() {
                                    var b = y()(h.a.mark(function X(b) {
                                        var c;
                                        return h.a.wrap(function(e) {
                                            for (;;) switch (e.prev = e.next) {
                                                case 0:
                                                    a.messenger = new J.a(a.window);
                            ...
                            d._initMasterMessenger = function() {
                                ...
                                this.messenger.subscribe("iframe_register", function(a, c) {
                                    var e = V.DOMUtils.offsets(a.sender);
                                    c({
                                ...
                                this.messenger.subscribe("iframe_data", function(b) {
                                    ...
                                    if (null != e) {
                                        ...
                                        if (c.events) {
                                            b = V.DOMUtils.offsets(b, {
                                                excludeBorder: !0
                                            });
                                            var k = b.left,
                                                f = b.top;
                                            b = c.events.map(function(b) {
                                                /mouse/.test(b.type) && (b.meta.x = Math.round(b.meta.x + k), b.meta.y = Math.round(b.meta.y + f));
                                                return p()({}, b, d, {
                            ...
                            d._initSlaveMessenger = function() {
                                ...
                                return (new f(function(b, c) {
                                    Y["default"].log("Awaiting subscription", a.document.documentElement);
                                    a.messenger.send("iframe_register", {
                                        awaitResponse: !0,
                                        timeoutTime: 3E3,
                                        onResponse: a._slaveMessengerRegistrationHandler(b, c),
                                        onTimeout: function() {
                                            Y["default"].warn("Slave recorder stopped due to a timeout: no response from the parent page within 1 seconds. This frame will be used as if it is master");
                                            b()
                                        }
                                    })
                                }))["catch"](function(b) {
                                    Y["default"].warn("Cant init recorder in frame");
                                    a.throwError(b, "slave-recorder");
                                    Y["default"].warn(b, a.document);
                                    return b
                                })
                            };
                            ...
                            F()(c, [{
                                ...
                                get: function() {
                                    ...
                                    var a = this.document.doctype || {},
                                        b = a.publicId,
                                        c = a.systemId;
                                    return "\x3c!DOCTYPE " + [a.name || "html", b ? ' PUBLIC "' + b + '"' : "", !b && c ? " SYSTEM" :
                                        "", c ? ' "' + c + '"' : ""
                                    ].join("") + "\x3e"
                                }
                            }, {
                        ...
                        da = {
                            IS_INCOGNITO: ia.IS_INCOGNITO,
                            IS_MOBILE_DEVICE: ia.IS_MOBILE_DEVICE,
                            DO_NOT_TRACK: ia.DO_NOT_TRACK
                        };
                    z.IterableUtils.forin(da, function(a) {
                        var b = {
                            value: da[a]
                        };
                        Object.defineProperty(qa, a, b);
                        Object.defineProperty(qa.prototype, a, b)
                    })
            ...
            function(a, b, c) {
                ...
                (a.exports = function(a, b) {
                    ...
                    if (null == a) {
                        var h = c = !0;
                        var q = !1
                    } else h = g.call(a, "c"), q = g.call(a, "e"), c = g.call(a, "w");
                    h = {
                        value: b,
                        configurable: h,
                        enumerable: q,
            ...
            function(a, b, c) {
                var d = c(73),
                    ...
                    l = Math.max;
                a.exports = function(a, b) {
                    var c, g, h = l(arguments.length, 2);
                    a = Object(f(a));
                    var n = function(d) {
                        try {
                            a[d] = b[d]
                    ...
                    for (g = 1; g < h; ++g) b = arguments[g], d(b).forEach(n);
                    if (c !== A) throw c;
                    return a
                }
            },
            ...
            function(a, b, c) {
                (function(b) {
                    (function(b, c) {
                        ...
                        function p() {
                            for (var a = 0; a < N; a += 2)(0, Q[a])(Q[a + 1]), Q[a] = A, Q[a + 1] = A;
                            N = 0
                        }
                        ...
                        function Z(a, b) {
                            b._state === R ? x(a, b._result) : b._state === U ? G(a, b._result) : E(b, A, function(b) {
                                return v(a,
                                    b)
                            }, function(b) {
                                return G(a, b)
                        ...
                        function u(b, c, e) {
                            c.constructor === b.constructor && e === q && c.constructor.resolve === k ? Z(b, c) : e === S ? (G(b, S.error), S.error = null) : e === A ? x(b, c) : a(e) ? z(b, c, e) : x(b, c)
                        }
                        ...
                        function v(a, b) {
                            if (a === b) G(a, new TypeError("You cannot resolve a promise with itself"));
                                ...
                                var c = typeof b;
                                null === b || "object" !== c && "function" !== c ? x(a, b) : u(a, b, B(b))
                            }
                        }
                        ...
                        function x(a, b) {
                            a._state === Y && (a._result = b, a._state = R, 0 !== a._subscribers.length && P(C, a))
                        }

                        function G(a,
                            b) {
                            a._state === Y && (a._state = U, a._result = b, P(w, a))
                        }
                        ...
                        function C(a) {
                            var b = a._subscribers,
                                c = a._state;
                            if (0 !== b.length) {
                                for (var e, d, k = a._result, f = 0; f < b.length; f += 3) e = b[f], d = b[f + c], e ? D(c, e, d, k) : d(k);
                        ...
                        function D(b, c, e, d) {
                            ...
                            if (k) {
                                ...
                                f === S ? (B = !0, g = f.error, f.error = null) : l = !0;
                                if (c === f) {
                                    G(c, new TypeError("A promises callback cannot return that same promise."));
                                    return
                                }
                            } else f = d, l = !0;
                            c._state === Y && (k && l ? v(c, f) : B ? G(c, g) : b === R ? x(c, f) : b === U && G(c, f))
                        }
                        ...
                        var L = void 0,
                            ...
                            fa = (L = "undefined" !== typeof m ? m : A) || {},
                            ca = fa.MutationObserver || fa.WebKitMutationObserver;
                        ...
                        var ha = Math.random().toString(36).substring(2),
                            ...
                            ja = function() {
                                function a(a, b) {
                                    ...
                                    this.promise[ha] || M(this.promise);
                                    J(b) ? (this._remaining = this.length =
                                        b.length, this._result = Array(this.length), 0 === this.length ? x(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(b), 0 === this._remaining && x(this.promise, this._result))) : G(this.promise, Error("Array Methods must be provided an Array"))
                                }
                                a.prototype._enumerate = function(a) {
                                    for (var b = 0; this._state === Y && b < a.length; b++) this._eachEntry(a[b], b)
                                };
                                a.prototype._eachEntry = function(a, b) {
                                    var c = this._instanceConstructor,
                                        d = c.resolve;
                                    d === k ? (d = B(a), d === q && a._state !== Y ? this._settledAt(a._state, b, a._result) :
                                        "function" !== typeof d ? (this._remaining--, this._result[b] = a) : c === O ? (c = new c(e), u(c, a, d), this._willSettleAt(c, b)) : this._willSettleAt(new c(function(b) {
                                            return b(a)
                                        }), b)) : this._willSettleAt(d(a), b)
                                };
                                a.prototype._settledAt = function(a, b, c) {
                                    var e = this.promise;
                                    e._state === Y && (this._remaining--, a === U ? G(e, c) : this._result[b] = c);
                        ...
                        O._setScheduler = function(a) {
                            W = a
                        };
                        O._setAsap = function(a) {
                            P = a
                        };
                        O._asap = P;
                        O.polyfill = function() {
            ...
            function(a, b, c) {
                (function(b, c) {
                    ! function(d) {
                        function f(a, b, c, e) {
                            b = Object.create((b && b.prototype instanceof h ? b : h).prototype);
                            e = new z(e || []);
                            b._invoke = k(a, c, e);
                            return b
                        }
                        ...
                        function q(a) {
                            function b(e, d, k, f) {
                                e = l(a[e], a, d);
                                if ("throw" === e.type) f(e.arg);
                                else {
                                    var g =
                                        e.arg;
                                    return (e = g.value) && "object" === typeof e && v.call(e, "__await") ? c.resolve(e.__await).then(function(a) {
                                        b("next", a, k, f)
                                    }, function(a) {
                                        b("throw", a, k, f)
                        ...
                        function k(a, b, c) {
                            ...
                            return function(k, f) {
                                ...
                                for (c.arg = f;;) {
                                    ...
                                    "throw" === g.type && (d = L, c.method = "throw", c.arg = g.arg)
                                }
                            }
                        }
                            ...
                            if (c === w) {
                                ...
                                if ("throw" === b.method) {
                                    if (a.iterator["return"] &&
                                        (b.method = "return", b.arg = w, e(a, b), "throw" === b.method)) return J;
                                    b.method = "throw";
                                    b.arg = new TypeError("The iterator does not provide a 'throw' method")
                                }
                                return J
                            }
                            c = l(c, a.iterator, b.arg);
                        ...
                        function Z(a) {
                            if (a) {
                                ...
                                if (!isNaN(a.length)) {
                                    ...
                                    b = function Q() {
                                        for (; ++c < a.length;)
                                            if (v.call(a, c)) return Q.value = a[c], Q.done = !1, Q;
                                        Q.value =
                                            w;
                                        Q.done = !0;
                                        return Q
                        ...
                        var u = Object.prototype,
                            ...
                            A = x.iterator || "@@iterator",
                            E = x.asyncIterator || "@@asyncIterator",
                            C = x.toStringTag || "@@toStringTag";
                        x = "object" === typeof a;
                        var D = d.regeneratorRuntime;
                        if (D) x && (a.exports = D);
                        else {
                            D = d.regeneratorRuntime = x ? a.exports : {};
                            D.wrap = f;
                            ...
                            (x = (x = Object.getPrototypeOf) &&
                                x(x(Z([])))) && x !== u && v.call(x, A) && (d = x);
                            var N = p.prototype = h.prototype = Object.create(d);
                            y.prototype = N.constructor = p;
                            p.constructor = y;
                            p[C] = y.displayName = "GeneratorFunction";
                            D.isGeneratorFunction = function(a) {
                                return (a = "function" === typeof a && a.constructor) ? a === y || "GeneratorFunction" === (a.displayName || a.name) : !1
                            };
                            D.mark = function(a) {
                                Object.setPrototypeOf ? Object.setPrototypeOf(a, p) : (a.__proto__ = p, C in a || (a[C] = "GeneratorFunction"));
                            ...
                            D.AsyncIterator = q;
                            D.async = function(a, b, c, e) {
                                var d = new q(f(a, b, c, e));
                                return D.isGeneratorFunction(b) ? d : d.next().then(function(a) {
                            ...
                            z.prototype = {
                                ...
                                dispatchException: function(a) {
                                    ...
                                    for (var c = this, e = this.tryEntries.length - 1; 0 <= e; --e) {
                                        ...
                                        if (d.tryLoc <= this.prev) {
                                            var f = v.call(d, "catchLoc"),
                                                g = v.call(d, "finallyLoc");
                                            if (f && g) {
                                ...
                                finish: function(a) {
                                    for (var b = this.tryEntries.length - 1; 0 <= b; --b) {
                                        ...
                                        if (c.finallyLoc === a) return this.complete(c.completion, c.afterLoc), H(c), J
                                    }
                                },
                                "catch": function(a) {
                                    for (var b = this.tryEntries.length - 1; 0 <= b; --b) {
                ...
                var d = c(3),
                    f = {
                        toChunks: function(a, b) {
                            var c = a.slice(0),
                                f = c.length,
                                g = f === b ? Math.round : Math.floor,
                                l = 0;
                            return c.reduce(function(a, h, k) {
                                var e = g(b / (f / k));
                                0 < k && 1 < e - l && d["default"].warn("Invalid index " + e + ": " + g(b / (f / (k - 1))) + " \x3c\x3d\x3e " + g(b / (f / k)), [c.length, k, b], [c.length / k], [b / (c.length / k)]);
                                l = e;
                                a[e] = a[e] || [];
                                a[e].push(h);
                                return a
    ...
    h.setTimeout = function(a, b, c) {
        return h.getNativeFunction("setTimeout")(D(a, c || "setTimeout"), b)
    };
    var w = J.inherit({
        ...
        on: function(a, b, c, d, f) {
            ...
            for (h = 0; h < l; h++) {
                ...
                g[g.length] = [a, r, c, d, f, y];
                a.addEventListener ? a.addEventListener(r, y, w._prepOpts(f)) : a.attachEvent && a.attachEvent("on" + r, y)
            }
        },
        ...
        _removeListener: function(a,
            b, c, d) {
            a.removeEventListener ? a.removeEventListener(b, c, w._prepOpts(d)) : a.detachEvent && a.detachEvent("on" + b, c)
        }
    });
    w.supportsPassive = function() {
        if (w._supportsPassive !== A) return w._supportsPassive;
        w._supportsPassive = !1;
        try {
            var a = Object.defineProperty({}, "passive", {
                get: function() {
                    return w._supportsPassive = !0
                }
            });
    ...
    x.initTime = x.getMs();
    w.on(m, "beforeunload,unload", function() {
    ...
    var Wa = J.inherit({
            ...
            _initComponent: function() {
                ...
                this.storage && (a = this.storage.get(this.storageKey)) && a.data && a.meta && a.time && a.time + this.bufferExpireTime > +x.getMs() && this.onFlush.call(this.onFlushCtx || this, this.dataFromStorage(a.data), a.meta, a.pnum);
                this.clear()
            },
        ...
        yb = "ru ua by kz az kg lv md tj tm uz ee fr co.il com.ge com.am com.tr".split(" "),
        E = {
            storage: {},
            init: function() {
                var a = this;
    ...
    h.async = function(a, b, c) {
        if (m.postMessage) {
            ...
            var f = function(c) {
                ...
                g === d && (c.stopPropagation && c.stopPropagation(), a.call(b), w.un(m, "message", f, null, {
                    passive: !1
                }))
            };
            w.on(m, "message", f, null, {
                passive: !1,
                name: ".async." + (c || "")
            });
            m.postMessage(d, "*")
    ...
    var $b = J.inherit({
            ...
            send: function(a, b, c, d) {
                var f = [a],
                    l = this,
                    g = c || function() {};
                l.isDisabled() ? g.call(d) : function y(a) {
                    if (a < this.transports.length) try {
                        ...
                        (function k(q) {
                            q >= f.length ? c.blockNext() || y.call(this, a + 1) : c.request(f[q], b, function(a, b, c) {
                        ...
                        ua(F, "send by " + (c && c.id)), y.call(this, a + 1)
                    }
                }.call(this, 0)
            }
        }),
    ...
    var Ba = J.inherit({
            ...
            _buildUrl: function(a, b) {
                var c =
                    wa.stringify(b, this.queryStringParams);
                ...
                if (m.XMLHttpRequest) {
                    ...
                    if ("withCredentials" in h) {
                        ...
                        h.onreadystatechange = function() {
                            if (4 === h.readyState) {
                                try {
                                    l = f._parseResp(h.responseText)
                                } catch (r) {
                                    return c.call(d, !1)
                                }
                                c.apply(d, [200 === h.status].concat(l))
                            }
                        };
    ...
    var ac = Ba.inherit({
        ...
        index: 1,
        request: function(a, b, c, d) {
            "function" === typeof navigator.sendBeacon && !u.isAndroidWebView() && navigator.onLine ? (b = this._splitParams(b), b.get["force-urlencoded"] = 1, c.call(d, navigator.sendBeacon(this._buildUrl(a, b.get), wa.stringify(b.post)))) : c.call(d, !1)
        }
    });
    ...
    var Za = Ba.inherit({
            ...
            _initComponent: function() {
                ...
                "_htmlfile" in Za.prototype || (Za.prototype._htmlfile = this._createHtmlfile());
    ...
    var S = J.inherit({
        counterId: "",
        _initComponent: function() {
            S.superclass._initComponent.apply(this, arguments);
            this._ls = null;
            try {
    ...
    h.hiddenFrameCreate = function(a, b) {
        var c;
        if (c = h._hiddenFrames[a]) return -1 === h.arrayIndexOf(c.owners, b) && c.owners.push(b), h.framePostMessage(c.frame, "frameReinit", "*"), c.frame;
        c = h.getNativeFunction("createElement", t)("iframe");
        h.mixin(c.style, {
            display: "none",
            width: "1px",
            height: "1px",
    ...
    h.hiddenFrameRemove =
        function(a, b) {
            var c = h._hiddenFrames[a],
                d;
            c && -1 !== h.arrayIndexOf(c.owners, b) && (c.owners = h.filter(function(a) {
                return a !== b
            }, c.owners), c.owners.length || ((d = c.frame.parentNode) && d.removeChild(c.frame), delete h._hiddenFrames[a]))
        };
    var ja = {
            ...
            tailSafe: "*-_",
            encode: function(a, b) {
                var c = (ja.abc + (b ? ja.tailSafe : ja.tail)).split(""),
                    d = a.length,
                    f = [],
                    l = d - d % 3,
                    g;
                for (g = 0; g < l; g += 3) {
                    ...
                    h.mergeArrays(f, [c[n >>
                        18 & 63], c[n >> 12 & 63], c[n >> 6 & 63], c[n & 63]])
                }
                switch (d - l) {
                    case 1:
                        n = a[l] << 4;
            ...
            decode: function(a, b) {
                for (var c = ja.abc + (b ? ja.tailSafe : ja.tail), d = 0, f = "", l, g, h, r, y; a.length % 4;) a += "\x3d";
                do {
                    l = c.indexOf(a.charAt(d++));
                    g = c.indexOf(a.charAt(d++));
                    r = c.indexOf(a.charAt(d++));
                    y = c.indexOf(a.charAt(d++));
                    if (0 > l || 0 > g || 0 > r || 0 > y) return null;
                    h = l << 18 | g << 12 | r << 6 | y;
                    l = h >> 16 & 255;
                    g = h >> 8 & 255;
                    h &= 255;
                    f = 64 == r ? f + String.fromCharCode(l) : 64 == y ? f + String.fromCharCode(l, g) : f + String.fromCharCode(l, g, h)
                } while (d < a.length);
                return f
            }
        },
    ...
    u.isSameSite = h.memorize(function() {
        var a = /Chrome\/(\d+)\./;
        return m.navigator && navigator.userAgent && (a = navigator.userAgent.match(a)) && 1 < a.length ?
            (a = parseInt(a[1], 10), 76 <= a) : !1
    });
    var N = J.inherit({
        counterId: "",
        onlyCurrentDomain: !1,
        ...
        _initComponent: function() {
            ...
            this._domain = null;
            u.isSameSite() && (this.sameSiteStr = "SameSite\x3dNone");
        ...
        create: function(a, b, c) {
            b = [this._prepareName(a) +
                "\x3d" + encodeURIComponent(b)
            ];
            if (this.isAllowed(a)) {
                c && (a = new Date, a.setTime(a.getTime() + 6E4 * c), b.push("expires\x3d" + a.toGMTString()));
                this.sameSiteStr && "https:" === m.location.protocol && (b.push(this.sameSiteStr), b.push("Secure"));
                this._domain && b.push("domain\x3d" + this._domain);
                b.push("path\x3d/");
                try {
                    t.cookie = b.join(";")
                } catch (d) {}
        ...
        isAllowed: function(a) {
            return h.inArray(["metrika_enabled", "gdpr", "gdpr_popup"], a) ? !0 : la.isAnalyticsCookeAllowed ? la.isAnalyticsCookeAllowed(E) : !1
        },
    ...
    u.isFF = D(function(a) {
        ...
        if (b && a && m.navigator && m.navigator.userAgent &&
    ...
    u.isITPSafari = h.memorize(function() {
        var a = u.getMacOSVersion();
        return (u.isIOS() || 10 < a[0] || 10 === a[0] && 13 <= a[1]) && u.isSafari()
    });
    var Da = {
            _storage: new S,
            globalConfig: null,
            ...
            checkVersion: function() {
                var a = u.edgVersion(),
                    b = u.getITPYaBroVersion();
                return this.globalConfig.get("isEU") ? 1 : 50 <= b && 99 >= b || a && 79 <= a ? 0 : !u.isITPSafari() || u.isSafariWebView()
            },
            noop: function() {},
            genPu: function(a) {
            ...
            genYm: function(a) {
                var b = this,
                    c = M(),
                    d = x.getMinutes();
                if (!this.checkVersion() && m.fetch && this._storage.get("retryReqs") && "yandex.ru" ==
                    ...
                    fetch("//" + f, {
                        ...
                        c && (a.resp = c._ym_uid, a.dmn = ja.encode(Qa.encode(f)), b._storage.set(b.ymKey, a))
                    })["catch"](function() {
            ...
            initPP: D(function(a) {
                ...
                this.globalConfig = a;
                if (m.navigator.onLine && b && a.get("pp") == A && (this.globalConfig.setSafe("pp", null), b && b.prototype && b.prototype.constructor &&
            ...
            initZZ: function() {
                ...
                if (!this.getZZ() && (!this.checkVersion() || b)) {
                    if (b || c && 79 <= c) a = "md";
                    this.zzUrl = "https://mc.yandex." + a + ja.decode("L21ldHJpa2EvenpsYy5odG1s");
                    h.hiddenFrameCreate(this.zzUrl, this.key);
                    w.on(m, "message", this.onMessage, this, {
                        passive: !1
                    });
                    this.timeout = h.setTimeout(function() {
                        w.un(m, "message", d.onMessage, d, {
                            passive: !1
                        });
                        h.hiddenFrameRemove(d.zzUrl, d.key);
                        d.zz = "na"
                    }, 3E3, "cd.initZZ")
                }
            },
            onMessage: function(a) {
                a.data && a.data.substr && "__ym__zz" === a.data.substr(0, 8) && (this.zz = a.data.substr(8), h.hiddenFrameRemove(this.zzUrl, this.key), this._storage.set(this.key, this.zz), w.un(m, "message", this.onMessage, this, {
                    passive: !1
            ...
            initFip: function() {
                var a = 0;
                a = u.isFF(68);
                !Object.keys || this.checkVersion() && !a || this._storage.get(this.fipKey) || (a = new kb(h.reduce(function(a, c) {
                    a[c] = 1;
                    return a
                }, {}, this.fpFactors)), a = a.toString(!1).join("-"), this._storage.set(this.fipKey, a))
            }
        },
        W = $b.inherit({
            protocol: "",
            ...
            counterType: 0,
            retry: !1,
            transports: [ac, Xa, Ca, bc],
            _initComponent: function() {
                W.superclass._initComponent.apply(this, arguments);
                this.retry && (this._storage = new S)
            },
            send: function(a, b, c, d) {
                var f = this.globalConfig.get(la.globalKey),
                    l = this;
                f && 3 !== this.counterId ? f(function() {
                    var f = l._registerRequest(a, b);
                    l._sendSavedRequest(f, a, b, c, d)
            ...
            _sendSavedRequest: function(a, b, c, d, f) {
                ...
                if ("process" == l) this.globalConfig.set("firstReqCallbacks", h.mergeArrays(this.globalConfig.get("firstReqCallbacks") || [], [
                    ...
                    c.st = x.getSeconds();
                    c.u = W._userID;
                    this.globalConfig.get("isEU") || (c = Da.updateInfo(c));
                    ...
                    return W.superclass.send.call(this, l, b, function() {
                        var b;
            ...
            _getVersion: D(function() {
                return ya
            }, "", !0)
        });
    W._storage = new S;
    W.initCookie = function(a) {
        var b = new N({
        ...
        else if (!l || 15768E3 < g - parseInt(l)) b.create(a, c, 525600),
            b.create("d", g, 525600);
        W._storage.set(a, c);
        W._userID = c;
        return f
    };
    W.retransmit = function(a) {
        var b = W._storage,
            c = b.get("retryReqs") || {},
            d;
        b.remove("retryReqs");
        h.forEachKey(c, function(b, c) {
            ...
            c.ghid && c.ghid != a.get("_globalMetrikaHitId") && c.time && c.time + 1728E5 > f && 500 < f - c.time && 2 >= c.browserInfo.rqnl && (d = new W({
                protocol: c.protocol,
                host: c.host,
                resource: c.resource,
    ...
    h.fletcher = function(a) {
        for (var b = a.length, c = 0, d = 255, f = 255, l, g, h; b;) {
            l = 21 < b ? 21 : b;
            b -= l;
            do g = "string" == typeof a ? a.charCodeAt(c) : a[c], c++, 255 < g && (h = g >> 8, g &= 255, g ^= h), d += g, f += d; while (--l);
            d = (d & 255) + (d >> 8);
            f = (f & 255) + (f >> 8)
        }
    ...
    var cc = /(\?|&)turbo_uid=([\w\d]+)($|&)/,
        dc = h.memorize(function() {
            var a = new N,
                b = M();
            return function(c) {
                return c(a, b)
    ...
    h.isNumber = function(a) {
        return isFinite(a) && !isNaN(a) && "[object Number]" ===
            h.toString(a)
    };
    ...
    h.isMetrikaPlayer = function() {
        return "MetrikaPlayer" ==
            m.name || this._playerRegexp.test(m.location.hostname)
    };
    h.isNativeFunction = function(a, b) {
        return a && "function" === typeof a ? (new RegExp("function\\s*" + b + "\\s*\\(\\)\\s*\\{\\s*\\[native[\\s-]code\\]\\s*\\}", "i")).test(a.toString()) : !1
    };
    var v = {},
        fc = h.memorize(function() {
            var a = {},
                b = 59,
                c = String.fromCharCode,
                d, f = "A B BIG BODY BUTTON DD DIV DL DT EM FIELDSET FORM H1 H2 H3 H4 H5 H6 HR I IMG INPUT LI OL P PRE SELECT SMALL SPAN STRONG SUB SUP TABLE TBODY TD TEXTAREA TFOOT TH THEAD TR U UL ABBR AREA BLOCKQUOTE CAPTION CENTER CITE CODE CANVAS DFN EMBED FONT INS KBD LEGEND LABEL MAP OBJECT Q S SAMP STRIKE TT ARTICLE AUDIO ASIDE FOOTER HEADER MENU METER NAV PROGRESS SECTION TIME VIDEO NOINDEX NOBR MAIN svg circle clippath ellipse defs foreignobject g glyph glyphref image line lineargradient marker mask path pattern polygon polyline radialgradient rect set text textpath title".split(" ");
            for (d = 0; d < f.length; d++) a[f[d]] = c(b), b++;
            return a
        });
    ...
    v.getDocumentTitle = function() {
        var a = t.title;
        "string" !=
        typeof a && (a = (a = t.getElementsByTagName("title")) && a.length ? a[0].innerHTML : "");
        return a
    };
    u.getSilverlightVersion = h.memorize(function() {
        if (m.ActiveXObject) try {
            ...
            b(a, d, 3, 1);
            var f = d.join(".")
        } catch (l) {} else if (b = m.navigator,
            b = b.plugins && b.plugins["Silverlight Plug-In"]) f = b.description;
        return f || ""
    });
    u.getFlashVersion = h.memorize(function() {
        var a = m.navigator;
        if ("undefined" != typeof a.plugins && "object" == typeof a.plugins["Shockwave Flash"]) {
            var b = a.plugins["Shockwave Flash"];
            var c = b.version;
            if ((b = b.description) || c)
                if (a = a.mimeTypes, "undefined" == typeof a || !a["application/x-shockwave-flash"] || a["application/x-shockwave-flash"].enabledPlugin) c ? u._flashVersion = c : b && (u._flashVersion = b.replace(/([a-zA-Z]|\s)+/, "").replace(/(\s+r|\s+b[0-9]+)/,
                    "."))
        } else if ("undefined" != typeof m.ActiveXObject) try {
            if (c = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"), b = c.GetVariable("$version")) u._flashVersion = b.split(" ")[1].replace(/,/g, ".").replace(/[^.\d]/g, "")
        } catch (d) {}
        return u._flashVersion
    });
    u.getLanguage = h.memorize(function() {
    ...
    u.getJavaEnabled = h.memorize(function() {
        try {
    ...
    u.getFingerPrint = h.memorize(function() {
        var a = [],
            b;
        ...
        if (navigator.mimeTypes && navigator.mimeTypes.length)
            for (b = 0; b < navigator.mimeTypes.length; b++) c = navigator.mimeTypes[b], h.mergeArrays(a, [c.type, c.description, c.suffixes]);
    ...
    u.isIframe = h.memorize(function() {
        try {
            return m.top != m
        } catch (a) {
            return !1
    ...
    u.isHeadLess = h.memorize(function() {
        var a, b = ["_phantom", "__nightmare", "callPhantom"];
        for (a = 0; a < b.length; a++)
            if (m[b[a]]) return !0;
        return /PhantomJS/.test(m.navigator.userAgent) || m.navigator.webdriver || m.isChrome &&
            !m.chrome ? !0 : /HeadlessChrome/.test(m.navigator.userAgent)
    });
    u.getNavigationStart = h.memorize(function() {
        var a = m.performance || m.webkitPerformance;
    ...
    w.ready = function(a) {
        ...
        if ("interactive" === b || "complete" === b) h.setTimeout(a, 0, "evt::ready");
            ...
            var c = function() {
                w.un(t, "DOMContentLoaded", c);
                w.un(m, "load", c);
                a()
            };
            w.on(t, "DOMContentLoaded", c);
            w.on(m, "load", c)
        }
    };
    var zb = {
        ...
        _send: function() {
            ...
            w.ready(function() {
                ...
                b.src = a.url + String.fromCharCode(97, 100, 118, 101, 114, 116, 46,
                    103, 105, 102);
                u.isSafari() && (b.style.position = "absolute", b.style.visibility = "hidden", b.style.width = "0px", b.style.height = "0px", v.getRootElement().appendChild(b))
            })
        },
        _saveReq: function(a) {
            this._value = a = a ? "1" : "2";
    ...
    var gc = h.memorize(function() {
            if (!m.yandex || !m.yandex.getSiteUid) return "";
            if (h.isFunction(m.yandex.getSiteUid)) return m.yandex.getSiteUid()
        }),
        Ra = W.inherit({
            hitId: 0,
            trackHash: !1,
                ...
                _reduce: function(a) {
                    return function(b, c) {
                        h.arrayEvery(h.keys(c), function(d) {
                            if (b.hasOwnProperty(d)) return 1; - 1 ==
                                h.arrayIndexOf(a, d) && (b[d] = c[d], delete c[d]);
                            return 1
                        });
                        return b
                    }
            ...
            sendTitle: !0,
            _initComponent: function() {
                Ra.superclass._initComponent.apply(this,
                    arguments);
            ...
            _sendGoal: function(a,
                b, c) {
                if (a) {
                    var d = b.url ? h.parseUrl(b.url) : M();
                    this._hitExt({
                        url: c + "://" + d.hostname + "/" + a,
            ...
            sendGoal: function(a, b) {
                /[/&=?#]/.test(a) ? h.warning("Incorrect goal") : this._sendGoal(a && encodeURIComponent(a), b, "goal")
            },
            sendForm: function(a, b) {
                this._sendGoal(a, b, "form")
            },
            ...
            _hitExt: function(a, b) {
                ...
                if (!h.isMetrikaPlayer()) {
                    var n = a.modes || {};
                    var r = a.browserInfo || {};
                    var y = "undefined" !== typeof a.referrer ? a.referrer : $a.lastReferrer;
                    var p = a.url || "";
                    var m = {};
                    a.nohit && c("nohit", 1);
                    n.ar && !n.onlyData && (y = null === y || "" === y ? "" : this._prepareHitUrl(y), p = this._prepareHitUrl(a.url));
                    c("forceNoRedirect", a.forceNoRedirect);
                    c("page-ref",
                        h.trim(y, mb));
                    c("page-url", h.trim(p, mb));
                    h.is4Bytes(a.title) && c("charset", "utf-8"); - 1 != M().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/) ? c("ut", lb) : "undefined" != typeof n.ut && c("ut", h.trim(n.ut, hc));
                    c("exp", a.experiments);
                    ...
                    (!f || h.isObject(f) && !f.__ym && !f.__ymu) && this.paramsQueue.length() && h.inArray(["go", "hit",
                        "pa"
                    ], b) && (f = this.paramsQueue.mixin(f));
                    f && (p = h.toJSON(f), this.trimParams && p.length > ic ? l = !0 : 7E5 < p ? h.warning("Too big params") : c("site-info", p));
                    n.saveRef && ($a.lastReferrer = y);
                    g = function(a, b) {
                        var c = {};
                        ...
                        gdpr: la.getState(this.globalConfig),
            ...
            _getTechInfo: function(a, b, c, d, f, l, g, n, r, y) {
                function p(a, b, c) {
                    var e = "" + b;
                    a && b && (c || -1 === e.indexOf(":")) &&
                        (q[a] = e)
                ...
                d = d || x.getTimestamp();
                f = f || x.getTimezone();
                p("j", u.getJavaEnabled() ? "1" : "");
                var k = u.isDesktop(this.globalConfig);
                k !== A && p("dp", k ? "1" : "0");
                p("nt", u.netType());
                p("ns", u.getNavigationStart());
                ea && p("s", ea.width + "x" + ea.height + "x" + (ea.colorDepth || ea.pixelDepth));
                m.devicePixelRatio && p("sk", m.devicePixelRatio);
                u.isSelenium() && p("iss", "1");
                u.isHeadLess() && p("hdl", "1");
                u.isIframe() && (p("ifr", "1"), p("sti", u.isSameOriginTopFrame() ? "1" : "0"));
                m.ia_document &&
                    m.ia_document.shareURL && m.ia_document.referrer && p("iia", "1");
                p("adb", zb.getVal());
                p("f", u.getFlashVersion());
                p("l", u.getSilverlightVersion());
                p("fpr", u.getFingerPrint());
                p("cn", this.counterNum);
                b.pa || (k = v.getViewportSize(), p("w", k[0] + "x" + k[1]));
                p("z", f);
                p("i", d);
                p("et", x.getSeconds());
                ...
                p("la", u.getLanguage());
                p("ntf", u.getNotificationPermission());
                h.random(100) || p("np", ja.encode(Qa.encode(h.trim(u.getPlatform(), 100))));
                l && p("wh",
                    "1");
                f = "ar ln re dl cpf ad nb pa pq pv ex".split(" ");
                for (d = 0; d < f.length; d++) F(f[d]);
                ...
                f.isEnabled() && (c = f.getStorageId(), d = f.get("reqNum"), y || (d ? d++ : d = 1), f.set("reqNum", d), f.get("reqNum") == d ? (p("ls", c), p("rqn", d)) : (f.remove("reqNum"), f.clearStorageId(), 1 < d && (p("ls", c), p("rqn", 0))));
                p("rn", h.random());
                p("hid", g);
                y || 3 == this.counterId || b.pq || p("ds", Wb(r));
                r._firstPaint || y || (r._firstPaint =
                    Yb(), p("fp", r._firstPaint));
                if (n) {
                    g = E.get("winNameNum");
                    if (!g) {
            ...
            _getTitle: function(a) {
                a = "undefined" == typeof a ? (a = v.getDocumentTitle()) ? h.trim(a, Ab) : "" : h.trim(a, Ab);
                return a
            }
        });
    ...
    v.getDocumentHTML = function() {
        ...
        if (c) b = c;
            ...
            c = b.attributes;
            var l = "";
            for (d = 0; d < c.length; d++)(f =
                c[d]) && (l += " " + f.name + '\x3d"' + (f.value || "") + '"');
    ...
    v.getDocumentScroll = function() {
        var a = v.getBody();
        return [m.pageXOffset || t.documentElement && t.documentElement.scrollLeft || a && a.scrollLeft || 0, m.pageYOffset ||
            t.documentElement && t.documentElement.scrollTop || a && a.scrollTop || 0
        ]
    };
    ...
    try {
        if (xb) {
            var kb = function(a) {
                ...
                var c = {};
                return b.ka = a, b.fa = c, b.i = function(a, c, l) {
                        ...
                        var d = Object.create(null);
                        if (b.s(d), Object.defineProperty(d, "default", {
                                enumerable: !0,
                                value: a
                            }), 2 & c && "string" != typeof a)
                            for (var f in a) b.i(d, f, function(b) {
                                return a[b]
                            }.bind(null, f));
                        return d
                    }, b.ga = function(a) {
                ...
                a = function() {
                    function a(a) {
                        ...
                        this.R = Object.keys(this.l).filter(function(a) {
                            return b.l[a]
                        }).map(function(a) {
                            return new b.S[a]
                        })
                    ...
                    return a.prototype.toString = function(a) {
                        ...
                        return a ? [B.hash(b.join(""), 210)] : b.map(function(a) {
                            return B.hash(a, 210)
                        })
                    }, a
                }();
                ...
                var d = function(a) {
                    ...
                    return c(b, a), b.prototype.V = function() {
                        ...
                        function() {
                            ...
                            a.shaderSource(h, "precision mediump float;varying vec2 varyinTexCoordinate;void main() {gl_FragColor\x3dvec4(varyinTexCoordinate,0,1);}");
                            a.compileShader(h);
                            a.attachShader(d, f);
                            a.attachShader(d, h);
                            a.linkProgram(d);
                            ...
                            try {
                                ...
                                l && (b.push("webgl unmasked vendor:" + a.getParameter(l.UNMASKED_VENDOR_WEBGL)), b.push("webgl unmasked renderer:" + a.getParameter(l.UNMASKED_RENDERER_WEBGL)))
                            } catch (k) {}
                    ...
                    return a.prototype.U = function() {
                        return this.c = this.canvas.getContext(this.P), !(!this.canvas.getContext || !this.c)
                ...
                a = function(a) {
                    ...
                    return c(b, a), b.prototype.u = function() {
                        var a = this.canvas,
                            b = this.c,
                            c = [];
                ...
                a = function() {
                    ...
                    return a.prototype.b = function() {
                        ...
                        for (var g = b.measureText(this.o).width, h = 0, r = a.length; h < r; h++) b.font = "30px " + a[h], c.push(b.measureText(this.o).width === g);
                        return c.join("x")
                    }, a
                }();
                b.D = a
                ...
                a = function() {
                    function a() {}
                    return a.prototype.b = function() {
                        if (!(c = m.speechSynthesis)) return "";
                        for (var a, b = [], c = c.getVoices(), g = 0; g < c.length; g++) a = c[g], b.push("" + a.name + a.lang + a.localService + a.voiceURI + a["default"]);
                        return b.join("")
                    }, a
                }();
                b.K = a
                ...
                a = function() {
                    ...
                    return a.prototype.b = function() {
                        var a = m.screen;
                        return [a.width, a.height, a.availWidth, a.availHeight, a.availTop].join("x")
                    }, a
                }();
                b.J = a
            }, function(a, b, c) {
                ...
                a = function() {
                    function a() {}
                    return a.prototype.b = function() {
                        return d.A(navigator.plugins).sort(function(a, b) {
                            return a.name > b.name ? 1 : 2
                        }).map(function(a) {
                            return [a.name,
                                a.description, d.A(a).map(function(a) {
                ...
                a = function() {
                    ...
                    return a.prototype.b = function() {
                        return this.h.doNotTrack ? this.h.doNotTrack : this.h.msDoNotTrack ? this.h.msDoNotTrack : "unknown"
                    }, a
                }();
                b.C = a
            }, function(a, b) {
                ...
                a = function() {
                    ...
                    return a.prototype.b = function() {
                        function a(a) {
                            return "" + (a = m.matchMedia("(" + a + ")")).media + (a.matches ? 1 : 0)
                        }
                        return [a("prefers-reduced-motion"), a("prefers-reduced-transparency"), a("prefers-color-scheme: dark"), a("prefers-color-scheme: light"), a("pointer: none"), a("pointer: coarse"),
                            a("pointer: fine"), a("any-pointer: none"), a("any-pointer: coarse"), a("any-pointer: fine"), a("scan: interlace"), a("scan: progressive"), a("color-gamut: srgb"), a("color-gamut: p3"), a("color-gamut: rec2020"), a("update: fast"), a("update: slow"), a("update: none"), a("grid: 0"), a("grid: 1"), a("hover: hover"), a("inverted-colors: inverted"), a("inverted-colors: none")
                        ].join("x")
                    }, a
                }();
                b.G = a
                ...
                a = function() {
                    ...
                    return a.prototype.b = function() {
                        ...
                        return [a.appName, a.vendor,
                            a.i, a.s, a.maxTouchPoints, a.appVersion, a.productSub, a.appCodeName, a.vendorSub, a.getGamepads && a.getGamepads().length
                        ].join("x")
                    }, a
                }();
                b.H = a
                ...
                a = function() {
                    ...
                    return a.prototype.w = function(a) {
                        return a || "0"
                    }, a.prototype.b = function() {
                        for (var a = t.createElement("video"), b = [], c = 1; c < this.types.length; c++) {
                            b.push(this.w(a.canPlayType(this.types[c] + ";")));
                            for (var g = 1; g < this.v.length; g++) b.push(a.canPlayType(this.w(this.types[c] + '; codecs\x3d"' + this.v[g] + '"')))
                        }
                        return b.join("")
                    }, a
                }();
                ...
                function c(a, b) {
                    ...
                    var c = [0, 0, 0, 0];
                    return c[3] += a[3] * b[3], c[2] += c[3] >>>
                        16, c[3] &= 65535, c[2] += a[2] * b[3], c[1] += c[2] >>> 16, c[2] &= 65535, c[2] += a[3] * b[2], c[1] += c[2] >>> 16, c[2] &= 65535, c[1] += a[1] * b[3], c[0] += c[1] >>> 16, c[1] &= 65535, c[1] += a[2] * b[2], c[0] += c[1] >>> 16, c[1] &= 65535, c[1] += a[3] * b[1], c[0] += c[1] >>> 16, c[1] &= 65535, c[0] += a[0] * b[3] + a[1] * b[2] + a[2] * b[1] + a[3] * b[0], c[0] &= 65535, [c[0] << 16 | c[1], c[2] << 16 | c[3]]
                }
                ...
                function d(a, b) {
                    ...
                    b = [b[0] >>> 16, 65535 & b[0], b[1] >>> 16, 65535 & b[1]];
                    var c = [0, 0, 0, 0];
                    return c[3] += a[3] + b[3], c[2] += c[3] >>> 16, c[3] &= 65535, c[2] +=
                        a[2] + b[2], c[1] += c[2] >>> 16, c[2] &= 65535, c[1] += a[1] + b[1], c[0] += c[1] >>> 16, c[1] &= 65535, c[0] += a[0] + b[0], c[0] &= 65535, [c[0] << 16 | c[1], c[2] << 16 | c[3]]
                }
                ...
                function n(a) {
                    return a = g(a, [0, a[0] >>> 1]), a = g(a = c(a, [4283543511, 3981806797]), [0, a[0] >>>
                        1
                ...
                b.hash = function(a, b) {
                    ...
                    var l = (a = a || "").length % 16,
                        ...
                        q = [0, b];
                    b = [0, b];
                    for (var k, e, B = [2277735313, 289559509], H = [1291169091, 658871167], z = 0; z < r; z += 16) k = [255 & a.charCodeAt(z + 4) | (255 & a.charCodeAt(z + 5)) << 8 | (255 & a.charCodeAt(z + 6)) << 16 | (255 & a.charCodeAt(z + 7)) << 24, 255 & a.charCodeAt(z) | (255 & a.charCodeAt(z + 1)) << 8 | (255 & a.charCodeAt(z + 2)) << 16 | (255 & a.charCodeAt(z + 3)) << 24], e = [255 & a.charCodeAt(z + 12) | (255 & a.charCodeAt(z + 13)) << 8 | (255 & a.charCodeAt(z +
                        14)) << 16 | (255 & a.charCodeAt(z + 15)) << 24, 255 & a.charCodeAt(z + 8) | (255 & a.charCodeAt(z + 9)) << 8 | (255 & a.charCodeAt(z + 10)) << 16 | (255 & a.charCodeAt(z + 11)) << 24], k = f(k = c(k, B), 31), q = d(q = f(q = g(q, c(k, H)), 27), b), q = d(c(q, [0, 5]), [0, 1390208809]), e = f(e = c(e, H), 33), b = d(b = f(b = g(b, c(e, B)), 31), q), b = d(c(b, [0, 5]), [0, 944331445]);
                    switch (k = [0, 0], e = [0, 0], l) {
                        case 15:
                            e = g(e, h([0, a.charCodeAt(z + 14)], 48));
                        case 14:
                            e = g(e, h([0, a.charCodeAt(z + 13)], 40));
                        case 13:
                            e = g(e, h([0, a.charCodeAt(z + 12)], 32));
                        case 12:
                            e = g(e, h([0, a.charCodeAt(z + 11)], 24));
                        case 11:
                            e = g(e, h([0, a.charCodeAt(z + 10)], 16));
                        case 10:
                            e = g(e, h([0, a.charCodeAt(z + 9)], 8));
                        case 9:
                            e = c(e = g(e, [0, a.charCodeAt(z + 8)]), H), b = g(b, c(f(e, 33), B));
                        case 8:
                            k = g(k, h([0, a.charCodeAt(z + 7)], 56));
                        case 7:
                            k = g(k, h([0, a.charCodeAt(z + 6)], 48));
                        case 6:
                            k = g(k, h([0, a.charCodeAt(z + 5)], 40));
                        case 5:
                            k = g(k, h([0, a.charCodeAt(z + 4)], 32));
                        case 4:
                            k = g(k, h([0, a.charCodeAt(z + 3)], 24));
                        case 3:
                            k = g(k, h([0, a.charCodeAt(z + 2)], 16));
                        case 2:
                            k = g(k, h([0, a.charCodeAt(z + 1)], 8));
                        case 1:
                            k = c(k = g(k, [0, a.charCodeAt(z)]), B), q = g(q, c(f(k, 31), H))
                    }
                    return q =
                        d(q = g(q, [0, a.length]), b = g(b, [0, a.length])), b = d(b, q), q = d(q = n(q), b = n(b)), b = d(b, q), ("00000000" + (q[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (q[1] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[0] >>> 0).toString(16)).slice(-8) + ("00000000" + (b[1] >>> 0).toString(16)).slice(-8)
                }
            }]);
            kb = kb["default"]
        }
    ...
    h.encodeURIComponent = function(a, b) {
        a = String(a);
        b && a.length > b && (a = a.substr(0, b));
    ...
    h.noop = function() {};
    h.framePostMessage = function(a, b, c) {
        a && a.contentWindow && a.contentWindow.postMessage && a.contentWindow.postMessage(b, c)
    };
    !jb(/webkit/) && jb(/gecko/);
    var nb = {
            asyncChunk: 400,
            ...
            addAsyncItem: function(a, b, c, d, f) {
                ...
                c ? (clearTimeout(this.timeout), l.flushAsync(!0)) : x.getMs() - this.rest >= this.restTime && !this.timeout ? (this.rest = x.getMs(), l.flushAsync()) :
                    this.timeout || (this.timeout = h.setTimeout(function() {
                        l.rest = x.getMs();
                        l.flushAsync();
                        l.timeout = !1
                    }, this.restTime))
            ...
            chain: function(a, b, c, d) {
                ...
                (function y(b, c, h) {
                    f.addAsyncItem(function(b, c, d) {
                        c = a[b++](c);
                        b <= a.length - 1 && y(b, c, d)
                    }, null, h, [b, c], d + "." + b)
                })(0, b, c)
            },
            callByTimeout: function(a, b) {
                for (var c = x.getMs(), d = 0, f, l = (b || 0) + 1, g = 0, n = this; this.asyncBuffer.length;)
                    if (f = this.asyncBuffer.shift(), g += 1, !f.isExecuted && (D(function() {
                            f.fn.apply(f.ctx,
                                f.args)
        ...
        ab = Wa.inherit({
            ...
            append: function(a) {
                ...
                ab.superclass.append.apply(this, arguments)
            },
            _getSize: function(a) {
                var b = this;
                this.chunkSize += encodeURIComponent(a).length;
                this.wrappers.length && h.reduce(function(a, d) {
            ...
            addData: function(a, b, c, d, f) {
                ...
                if (!this.totalSendLimit ||
                    this._totalSendedSize < this.totalSendLimit)
                    if (this._v = c, this.wrappers.length && h.arrayEvery(this.wrappers, function(c) {
                        ...
                        if (f > this.maxBufferSize)
                            for (this._data.length && this._flush(), d = Math.ceil(c.length / r); l < c.length;) n.partNum = g, n.end = g === d, n.data = c.slice(l, l += r), g++, this._getSize(n.data), this.append([n], !0);
        ...
        K = function(a) {
            ...
            function f(a) {
                function b(a, c) {
                    ...
                    Object.create(Error.prototype)).constructor = b;
            ...
            function h() {
                ...
                a.lo =
                    (a.lo | (127 & this.buf[this.pos]) << 28) >>> 0;
            ...
            f.create = m.Buffer ? function(a) {
                return (f.create = function(a) {
                    return m.Buffer.isBuffer(a) ? new r(a) : k(a)
                })(a)
            } : k;
            f.prototype._slice = m.Array.prototype.subarray ||
            ...
            f.prototype["float"] = function() {
                if (this.pos + 4 > this.len) throw d(this, 4);
                var a = m["float"].readFloatLE(this.buf, this.pos);
                this.pos += 4;
                return a
            };
            f.prototype["double"] = function() {
                if (this.pos + 8 > this.len) throw d(this, 4);
                var a = m["float"].readDoubleLE(this.buf, this.pos);
                this.pos += 8;
                return a
            };
            ...
            f._configure = function(a) {
                ...
                m.merge(f.prototype, {
                    ...
                    sint64: function() {
                        return h.call(this).zzDecode()[b](!1)
                    },
                    fixed64: function() {
            ...
            g.prototype.int32 = function(a) {
                return 0 > a ? this._push(m, 10, k.fromNumber(a)) :
                    this.uint32(a)
            };
            ...
            g.prototype.bytes = function(a) {
                ...
                return this.uint32(b)._push(H,
                    b, a)
            };
            g.prototype.string = function(a) {
                var b = B.length(a);
                return b ? this.uint32(b)._push(B.write, b, a) : this._push(n, 1, 0)
            };
            ...
            d.prototype.rpcCall = function F(a, b, c, d, h) {
                if (!d) throw TypeError("request must be specified");
                var g = this;
                if (!h) return f.asPromise(F, g, a, b, c, d);
                if (g.rpcImpl) try {
            ...
            var r = n && n.prototype instanceof Uint8Array && "set" === n.prototype.set.name ? function(a, b, c) {
                b.set(a, c)
            } : function(a, b, c) {
                if (a.copy) a.copy(b,
                    c, 0, a.length);
            ...
            d.from = function(a) {
                ...
                return a.low || a.high ? new d(a.low >>> 0, a.high >>> 0) : h
            };
            ...
            d.fromHash = function(a) {
                return a === g ? h : new d((n.call(a, 0) | n.call(a, 1) << 8 | n.call(a, 2) << 16 | n.call(a, 3) << 24) >>> 0, (n.call(a, 4) | n.call(a, 5) << 8 | n.call(a, 6) << 16 | n.call(a, 7) << 24) >>> 0)
            };
            ...
            d.prototype.length = function() {
                var a = this.lo,
                    ...
                    c = this.hi >>> 24;
                return 0 === c ? 0 === b ? 16384 > a ? 128 > a ? 1 : 2 : 2097152 > a ? 3 :
                    4 : 16384 > b ? 128 > b ? 5 : 6 : 2097152 > b ? 7 : 8 : 128 > c ? 9 : 10
            }
        }, function(a, b, c) {
            ...
            b.read = function(a, b, c) {
                if (1 > c - b) return "";
                for (var d, f = null, h = [], l = 0; b < c;) d = a[b++],
                    128 > d ? h[l++] = d : 191 < d && 224 > d ? h[l++] = (31 & d) << 6 | 63 & a[b++] : 239 < d && 365 > d ? (d = ((7 & d) << 18 | (63 & a[b++]) << 12 | (63 & a[b++]) << 6 | 63 & a[b++]) - 65536, h[l++] = 55296 + (d >> 10), h[l++] = 56320 + (1023 & d)) : h[l++] = (15 & d) << 12 | (63 & a[b++]) << 6 | 63 & a[b++], 8191 < l && ((f || (f = [])).push(String.fromCharCode.apply(String, h)), l = 0);
                return f ? (l && f.push(String.fromCharCode.apply(String, h.slice(0, l))), f.join("")) : String.fromCharCode.apply(String, h.slice(0, l))
            };
            b.write = function(a, b, c) {
                for (var d, f, h = c, l = 0; l < a.length; ++l) d = a.charCodeAt(l), 128 > d ? b[c++] =
                    d : (2048 > d ? b[c++] = d >> 6 | 192 : (55296 == (64512 & d) && 56320 == (64512 & (f = a.charCodeAt(l + 1))) ? (d = 65536 + ((1023 & d) << 10) + (1023 & f), ++l, b[c++] = d >> 18 | 240, b[c++] = d >> 12 & 63 | 128) : b[c++] = d >> 12 | 224, b[c++] = d >> 6 & 63 | 128), b[c++] = 63 & d | 128);
                return c - h
            }
        }, function(a, b, c) {
            a.exports = function(a) {
                ...
                "undefined" != typeof Float32Array ? function() {
                    ...
                    function b(a, b, c, e) {
                        ...
                        if (0 === b) a(0 < 1 / b ? 0 : 2147483648, c, e);
                            ...
                            b) a((d << 31 | Math.round(b / 1.401298464324817e-45)) >>> 0, c, e);
                        else {
            ...
            var d = Array(64),
                f = Array(123);
            for (a = 0; 64 > a;) f[d[a] = 26 > a ? a + 65 : 52 > a ? a + 71 : 62 > a ? a - 4 :
                a - 59 | 43] = a++;
            b.encode = function(a, b, c) {
                ...
                return g ? (l && g.push(String.fromCharCode.apply(String, h.slice(0, l))), g.join("")) : String.fromCharCode.apply(String, h.slice(0, l))
            };
            b.decode = function(a, b, c) {
                for (var d,
                        g = c, h = 0, l = 0; l < a.length;) {
            ...
            a.exports = function(a, b) {
                for (var c = Array(arguments.length -
                        1), d = 0, f = 2, h = !0; f < arguments.length;) c[d++] = arguments[f++];
                            ...
                            a.proto = function() {
                                        ...
                                        for (var c = void 0 === b ? a.len : a.pos + b, e = new g.ru.yandex.metrika.wv2.proto.BufferWrapper; a.pos < c;) {
                                            ...
                                            switch (k >>> 3) {
                                                case 1:
                                                    ...
                                                    e.buffer.push(g.ru.yandex.metrika.wv2.proto.Buffer.decode(a,
                                                        a.uint32()));
                                                    break;
                                                default:
                                                    a.skipType(7 & k)
                                ...
                                a.Buffer = function() {
                                    ...
                                    a.encode = function(a, b) {
                                        ...
                                        null != a.data && Object.hasOwnProperty.call(a,
                                            "data") && g.ru.yandex.metrika.wv2.proto.Wrapper.encode(a.data, b.uint32(18).fork()).ldelim();
                                ...
                                a.Wrapper = function() {
                                    ...
                                    a.encode = function(a, b) {
                                        ...
                                        null != a.mutation && Object.hasOwnProperty.call(a, "mutation") && g.ru.yandex.metrika.wv2.proto.Mutation.encode(a.mutation,
    ...
    try {
        var bb = {
            ...
            lc = h.reduce(function(a, b) {
                return a.concat(h.map(function(a) {
                    return {
                        eventName: a,
                        type: bb[b].type,
                        repeated: bb[b].repeated,
                        typeStr: b
                    }
                }, bb[b].events))
            }, [], h.keys(bb)),
            mc = {
                ...
                serializeBuffer: function(a, b, c) {
                    ...
                    b || (d.data = a);
                    c !== A && (d.stamp = c);
                    b && b.stamp === A && (d.stamp = x.getFormStart());
                    return d
                },
                toTransport: function(a, b, c, d) {
                    var f = b || "BufferWrapper",
                        h = this;
                    if (c) nb.chain([function() {
                ...
                serialize: function(a, b, c) {
                    var d = {},
                        f = {},
                        h = this[a + "Serialize"];
                    if (h) d[a] = h.call(this, b), f = new K.Wrapper(d);
                    else if (c && K.Wrapper.prototype[a] !== A) f[a] = b;
                    else throw "Unrecoginze type of message";
                    return c ? K.Wrapper.encode(f).finish() : f
                }
            };
        Bb = !0
    } catch (a) {
    ...
    var Cb = Wa.inherit({
            ...
            sendEncoded: function(a, b, c, d, f) {
                ...
                if (h > this.maxBufferSize) {
                    for (g = Math.ceil(a.length / this.maxChunkSize); r < h;) {
                        b.page = t;
                        b.end = t === g;
            ...
            addData: function(a, b, c, d, f) {
                ...
                if (!this.totalSendLimit || this._totalSendedSize < this.totalSendLimit)
                    if (this._v = c, this.wrappers.length && h.arrayEvery(this.wrappers, function(c) {
                        ...
                        x.getSeconds()), this.updateStamp(b, l), g = this.serializer.serialize(a, b), d ? (c = this.serializer.toTransport(g, "Wrapper"), this.sendEncoded(c, l, g, !0, {
                        id: a,
                        data: b
    ...
    T._check = D(function() {
        return -1 < m.location.href.indexOf("_ym_debug\x3d1") || m._ym_debug || "1" === T._cookie.read("debug")
    });
    T.enabled = T._check();
    T.log = D(function() {
        (-1 < L.href.indexOf("_ym_debug\x3d1") || m._ym_debug) && this._cookie.create("debug", "1");
        m.console && console.log && this._check() && (T.enabled = !0, console.log.apply(console, arguments))
    }, "DebugConsole.log");
    var nc = J.inherit({
        eventMap: {
            mousemove: {
    ...
    var C = {
        ...
        cb = J.inherit({
            ...
            _postprocessData: function(a, b) {
                ...
                a.pageUrlCanonical || (a.pageUrlCanonical = C.looksLikeFullUrl(a.id) ?
            ...
            _getTitleFromContent: function(a) {
                var b, c;
                for (b = 1; 5 >= b; b++)
                    if (c = C.getVal(C.selectOne(a, "h" + b))) return c;
                return null
            },
            _getType: function() {
                return 1
            ...
            contentSizeWarning: function(a) {
                -1 === h.arrayIndexOf(this.alreadyWarned, a.id) && (T.log("Warning: content has only " + a.chars + " chars.Required " + Ea[a.type], a), this.alreadyWarned.push(a.id))
            },
            findContent: function() {
                ...
                for (a = 0; a < f.length; a++)
                    if (d = this._getContentData({
                        ...
                        h.map(function(a) {
                            a && (a.chars <= Ea[a.type] ? l.contentSizeWarning(a) : (a = h.mixin({
                                sended: !1,
                                involvedTime: 0
    ...
    var pb = cb.inherit({
            id: "s",
            isAuthorsInTitle: !0,
            typesRegExp: new RegExp("schema.org\\/(" + h.keys(cb.prototype.typesMap).join("|") + ")$"),
            fields: {
                node: function(a) {
                ...
                id: function(a) {
                    ...
                    return b ? C.getVal(b) : (b = C.selectPropOne(a,
                ...
                topics: function(a) {
                    ...
                    return b = h.map(function(a) {
                            ...
                            if (a = C.selectPropOne(a, "name")) b.name = C.getVal(a);
                            return b
                        },
                        a)
                },
                rubric: function(a) {
                    ...
                    a && (a = C.selectProp(a, "itemListElement"), b = h.map(function(a) {
                        return {
                ...
                publicationDate: function(a) {
                    return (a = C.selectPropOne(a.element,
                        "datePublished")) ? C.getDate(a) : ""
                },
                ...
                pageTitle: function(a) {
                    var b = "",
                        c = a.element,
                        d = C.selectPropOne(c, "headline");
                    d && (b += C.getVal(d));
                    (d = C.selectPropOne(c, "alternativeHeadline")) && (b += " " + C.getVal(d));
                    "" === b && ((d = C.selectPropOne(c, "name")) || (d = C.selectPropOne(c, "itemReviewed")), d && (b += C.getVal(d)));
                    3 === a.type && (a = C.closest(c, '[itemtype$\x3d"schema.org/Question"]')) && (d = C.selectPropOne(a,
                        "text")) && (b += C.getVal(d));
                    return b
                },
                authors: function(a) {
            ...
            _getContentData: function(a) {
                return a.element &&
                    a.element.innerText && a.element.innerText.length ? pb.superclass._getContentData.call(this, a) : null
            },
        ...
        db = cb.inherit({
            ...
            fields: {
                ...
                rubric: function(a) {
                    var b =
                        ...
                        d = this;
                    h.map(function(a) {
                        a = aa.parse(a.innerText);
                        var b;
                        a && ((b = d._getGraph(a)) ? h.map(function(a) {
                            "BreadcrumbList" === a["@type"] && c.push(a)
                        }, b) : "BreadcrumbList" === a["@type"] && c.push(a))
                    }, [a.element].concat(h.toArray(C.select(t.body === b ? t.documentElement : b, this.dataNodesSelector))));
                    return c.length && (c = c[0].itemListElement, h.isArray(c)) ? h.filter(Boolean, h.map(function(a) {
                        return a.item && !isNaN(a.position) ? {
                            name: a.item.name || a.name,
                            position: a.position
                        } : null
                    }, c)) : []
                }
            ...
            _extractElementByHashedUrl: function(a) {
                ...
                try {
                    if (b = h.parseUrl(a).hash)
                        if (c = C.selectOne(t.body, b)) return c
                } catch (d) {
                    return null
                }
            },
            ...
            _getContentData: function(a) {
                var b = a.element,
                    ...
                    d = [],
                    f;
                if (!a.data && (a.data = aa.parse(b.innerText), !a.data || !/schema\.org/.test(a.data["@context"]) && !h.isArray(a.data))) return null;
                if (d = this._getGraph(a.data)) return h.map(function(a) {
                    if (!h.inArray(c.schemaEntities["schema.org"],
                            a["@type"])) return null;
                    a = {
                        element: b,
                        data: a,
                ...
                return d = db.superclass._getContentData.call(this, h.mixin(a, {
                    type: d
                }))
            },
            _findContentDescriptionNodes: function() {
                return C.select(m.document, this.dataNodesSelector)
            },
            _getGraph: function(a) {
                return h.isArray(a) && a || a && h.isArray(a["@graph"]) && a["@graph"]
            }
        }),
        Db = cb.inherit({
            id: "o",
            ...
            _findContentDescriptionNodes: function() {
                var a = [t.head],
                    b = C.select(t.body, 'meta[property\x3d"og:type"]');
            ...
            _getEntityData: function(a) {
                ...
                d = C.select(d === t.head ? d : l, "meta[property]");
                var g, n = new RegExp("^(og:)?((" + this.schemaEntities.opengraph.join("|") +
                    "):)?");
                if (d && d.length) h.map(function(a) {
                    try {
                        if (g = a.parentNode === l || a.parentNode === m.document.head) b = a.getAttribute("property").replace(n, ""), c = a.getAttribute("content"), f[b] ? h.isArray(f[b]) ? f[b].push(c) : f[b] = [f[b], c] : f[b] = c
                    } catch (y) {}
                }, d);
                else return null;
            ...
            _getContentData: function(a) {
                return (a = this._getEntityData(a)) ? Db.superclass._getContentData.call(this,
                    a) : null
            }
        }),
        oc = J.inherit({
            ...
            findContent: function(a) {
                ...
                this.articles = this.articles.concat(h.filter(function(a) {
            ...
            send: function() {
                ...
                a.length && (this.push({
                    articleInfo: a
                }), T.log("Publisher content info found:", a), h.arrayEvery(this.articles,
                    function(a) {
                        a.sended = !0;
                        return 1
                    }))
            ...
            start: function(a) {
                ...
                }), this._schema = new this.schemas[a.schema], this._schema.root = this.root, T.log('Publishers analytics schema "' +
        ...
        Eb = J.inherit({
            ...
            _getBufferType: function() {
                ...
                if (!T.enabled && Bb) {
                    ...
                    b && m.Uint8Array && m.Uint8Array.prototype.slice && (a = Cb)
                }
                return a
            },
            _initComponent: D(function() {
                var a = this._getBufferType();
                this._localStorage = new S({
                    counterId: this.counterId
                });
                ...
                var d = c.read("visorc");
                "b" !== d && "w" !== d && (d = "");
                c.isEnabled() && c.isAllowed() && !jb("opera mini") || (d = "b");
                this._publisher = new oc({
                    counterId: this.counterId,
                    globalConfig: this.globalConfig
                });
                this._vc = d;
                ...
                "b" !== d && (this._formRecorder =
                    new Sb(this.protocol, this.counterId, this.counterType, this.hid, this.globalConfig), this._recorder.on("error", function(a) {
                        ua(a.error, a.namespace)
                    }), this._activity = new nc);
                Eb.superclass._initComponent.apply(this, arguments)
            }, "wv2.init"),
            start: D(function(a, b) {
                var c = this,
                    d = this._vc;
                if (this._recorder) {
                    a = a || {};
                    ...
                    "w" === d && this.isEnabled() && this.globalConfig.setSafe("wv2Counter",
                        this.counterId);
                    ...
                    this._publisher && !this._publisher.isStopped && (this._eventsBuffer.wrappers.push(this._publisher), this._eventsBuffer.setWVType(this._buffer instanceof Cb ? 5 : 4), this._publisher.middleware(function(a) {
                        c.send(a)
                    }))
                }
            }, "wv2.start"),
            ...
            isEnabled: function() {
                ...
                return this.enabled && m.MutationObserver &&
                    a
            },
            send: function(a, b) {
                var c = a._v;
                h.forEachKey(a, function(a, f) {
                    ...
                    if (d) {
                        var m = d.name;
                        h.inArray(["event", "articleInfo"], m) && (g = this._eventsBuffer);
                        d.iterate ? h.forEachKey(f, function(a, d) {
                            var f = "eof" === d.type && !d.frameId,
                                h = [g],
                                l;
                            f && (h = [this._eventsBuffer, this._buffer]);
                            for (l = 0; l < h.length; l++) this.executor.addAsyncItem(h[l].addData, h[l], f, [m, d, c, f, b], "send." + (d ? d.type || d.group || "" : "empty"))
        ...
        Fb = {
            ...
            handle: function(a) {
                ...
                "init" == d ? (d = "yaCounter" + c, m[d] || (a = h.mixin(a[2] || {}, {
                        id: +c
                    }), m[d] = new m.Ya[this.constructorName](a))) : h.inArray(this.counters, b) &&
                    f && f[d] ? (a = [].slice.call(a, 2), f[d].apply(f, a)) : h.inArray(this.counters, b) || (this.waitPool[b] || (this.waitPool[b] = []), this.waitPool[b].push(a));
                return 1
            },
        ...
        Gb = Xa.inherit({
            ...
            _buildUrl: function(a, b) {
                b.wmode = 7;
                return Gb.superclass._buildUrl.apply(this, [a, b])
            },
            _parseResp: function(a) {
                var b = aa.parse(a);
                if (!b) throw "";
        ...
        qb = Ra.inherit({
                ...
                if (a) {
                    a: {
                        if (a = h.parseUrl(a).host.match(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/))
                            if (a = a[0].split("yandex").reverse()[0].substring(1), -1 != h.arrayIndexOf(yb, a)) break a;a = !1
                    }
            ...
            sendHit: function(a) {
                ...
                a.visitColor &&
                    (b.vc = a.visitColor);
                c && (this._ilStorage.remove("il"), b.ilt = ja.encode(Qa.encode(h.trim(c, Hb))));
        ...
        Ib = J.inherit({
            ...
            hit: function(a, b) {
                var c = this,
                    ...
                    l = this.EXPIRE_TIME,
                    g = [],
                    m = this.globalConfig.get("fakeHit");
                if (m && d) return m(function(b) {
                    a(b)
                });
                !f && d && (f = this._cookie.read(this.KEY_NAME)) && (f = aa.parse(f));
                f && f.params && f.time + l > x.getMs() ? (c.globalConfig.set("isEU", f.params.eu), a(f)) : (this.globalConfig.set("fakeHit", function(a) {
                    g.push(a)
            ...
            _getSender: function() {
                this._sender || (this._sender = new qb({
                    protocol: "https:",
            ...
            updateCookies: function() {
                var a = this._storage.get(this.KEY_NAME),
                    b = this._cookie.read(this.KEY_NAME);
                a && !b && this._cookie.create(this.KEY_NAME, aa.stringify(a), this.EXPIRE_TIME / 5E4)
            }
        }),
        Jb = J.inherit({
            baseUrl: "mc.yandex.",
            ...
            _initComponent: function() {
                ...
                this.syncTlds = h.reduce(function(a,
                    c) {
                    return c(a)
                }, yb, [h.bind(h.filter, null, function(b) {
                    return b !== a.baseTld
            ...
            sync: function(a) {
                var b = this,
                    c = -1 != M().hostname.search(/(?:^|\.)(?:ya|yandex(sport)?|beru|kinopoisk|edadeal)\.(?:\w+|com?\.\w+)$/),
                    d = !1,
                    f = c ? this._need(1) : !1;
                d = this._need(0);
                if (u.isIframe() || u.isITPSafari()) return a();
                this._is() ? a() : d || f ? (this._setStatus(!0), b._sync(d, function() {
                    c && b._syncAdmetrica();
                    b._sync(f, a)
                })) : a();
                c && this._addMda()
            ...
            _need: function(a) {
                var b = this._getDomainByLang(),
                    c = this._getTld(),
                    d = [],
                    f;
                1 === a && ((f = this.syncTlds[c]) && d.push.apply(d, f), f = this.syncTlds[b], b !== c && f && d.push.apply(d, f));
                0 === a && d.push("com");
                var l = this._getLs().get("synced") || {};
                d = h.arrayFilter(d, function(a) {
                    return (l[a] || 1) + 1440 < x.getMinutes()
                });
                return d.length && d || !1
            },
            ...
            _sync: function(a, b) {
                ...
                if (0 < f) {
                    ...
                    for (c = 0; c < f; c++)(function(a) {
                        r.request("https://" + (h._replaceBase[a] ? a : h.baseUrl + a) + "/sync_cookie_image_check", {}, function(b) {
                            g();
                            var c = x.getMinutes();
                            b || (c -= 1435);
                            b = m.get("synced") || {};
    ...
    var qc = function(a,
        ...
        rc = function(a, b) {
            0 === parseFloat(a.c_recp) && (Kb(b), b.s.set("ymoo" + b.k, x.getMinutes()))
        },
        sc = function(a) {
            var b = x.getMinutes(),
                c;
            a.s.isEnabled() && (c = a.s.get("ymoo" + a.k)) && 30 > b - c && Kb(a)
        },
        tc = Xa.inherit({
            id: "RawBodyXHR",
            index: 9,
    ...
    var Sa = {
            ...
            save: function(a, b) {
                this._getReq().request(this._url + wa.stringify({
                    key: a,
                    value: h.toJSON(b)
                }));
                this._getLs().set(a, b)
            ...
            _getReq: function() {
                this._req || (this._req = new Ca);
                return this._req
            }
        },
        uc = {
            sync: D(function(a, b, c, d) {
                var f = {
                    t: 'UV|L7,!"T[rwe\x26D_\x3eZIb\\aW#98Y.PC6k'
                };
                this.globalConfig = d || E;
                if (this._enabled(a, b, c)) {
                    ...
                    (function p(a) {
                        var b = g[a];
                        a < m ? h.request(b[0] + ":" + b[1] + "/p", f, function(c, d) {
            ...
            _getHosts: function() {
                var a = [],
                    b = L.protocol,
                    c = u.isIOS();
                (u.isAndroid() || c && "http:" === b) && a.push(["http://127.0.0.1", "30102"], ["http://127.0.0.1", "29009"]);
            ...
            _enabled: function(a, b, c) {
                var d = .1 >= Math.random();
                if (!(60 < x.getMinutes() - Sa.getNum("ds")) || this._is() || h.isDev(this.globalConfig)) return !1;
                0 === b && 67993306 === a && (d = 1);
                a = 0 === b && 0 <= h.arrayIndexOf([39370095, 1282253, 29302335, 43653484, 41734944, 31048081, 16443139, 27737346, 41870499, 33911514, 30744873, 5564395, 2580487, 67993306], a);
                d = pa() || !c && d && a;
                c = u.isIOS() && d;
                return u.isAndroid() && d || c
            },
            _setStatus: function(a) {
                try {
    ...
    u.isSearchRobot = h.memorize(function() {
        return (new RegExp("(" + "yandex.com/bots|Googlebot|APIs-Google|Mediapartners-Google|AdsBot-Google|FeedFetcher-Google|Google-Read-Aloud|DuplexWeb-Google|Google Favicon|googleweblight|Mail.RU_Bot|StackRambler|Slurp|msnbot|bingbot|www.baidu.com/search/spi_?der.htm".replace(/[./]/g,
            "\\$\x26") + ")")).test(m.navigator.userAgent)
    });
    var Ia = J.inherit({
        counter: null,
        prefsEcommerce: null,
        ...
        initUserLayer: function() {
            ...
            if (this.prefsEcommerce ||
                this.prefsUseDataLayer) this._overridePush(this.prefsEcommerce) || (h.isString(this.prefsEcommerce) && (this.dataLayerName = this.prefsEcommerce), a = this.dataLayerName, this._tryTimeout = h.bind(this._tryTimeout, this), this._tryTimeout()), this.counter._ecommerce = a
        },
        ...
        _tryTimeout: function() {
            this._overridePush(m[this.dataLayerName]) ||
                (this.overrideTimeout = h.setTimeout(this._tryTimeout, 1E3, "dlObserver"))
        },
        _callHandlers: function(a) {
            h.arrayEvery(Ia.handlers, function(b) {
                b && b.type && h.arrayEvery(b.type.split(","), function(c) {
        ...
        _convert: function(a, b) {
            ...
            if (b.items) {
                ...
                1 < c.length && (l[a].actionField =
                    h.reduce(function(a, c) {
            ...
            for (f = a.length; l < f; l++) {
                if ((d = a[l]) && d.ymetrikaEvent) {
                    ...
                    if ("params" === g.type && g.data) {
                        ...
                        g.status == this.status.NEW &&
                            g.parent && this.frameConnector && this.frameConnector.checkFrame(m.parent) && m.parent !== m && (this.frameConnector.sendToParents({
                                type: "params",
                                data: g.data
                            }, function() {
    ...
    var xa = ["0",
        ...
        Lb = xa[1],
        Mb = "GDPR-ok GDPR-cross GDPR-cancel GDPR-cookie-success GDPR-frame-skip GDPR-frame-ya GDPR-frame-noya GDPR-open-start GDPR-eu-skip GDPR-open-fail GDPR-open-success GDPR-skip GDPR-cookie-fail GDPR-skip-login GDPR-skip-domain GDPR-skip-na GDPR-skip-eu-na GDPR-skip-wv GDPR-settings GDPR-ok-view-default GDPR-ok-view-detailed 21 22 23 GDPR-ok-view-detailed-0 GDPR-ok-view-detailed-1 GDPR-ok-view-detailed-2 GDPR-ok-view-detailed-3 28".split(" "),
        vc = [0, 3, 13, 14, 15, 16, 17, 28],
        wc = ["https://brozen.yandex.ru",
            "https://yabro1.zen-test.yandex.ru/yabro/index.html", "https://yabro2.zen-test.yandex.ru/yabro/index.html"
        ],
        la = J.inherit({
            globalKey: "f1",
            MAX_SIZE: 1E6,
            ...
            parseValue: function(a) {
                a = h.inArray(["GDPR-ok-view-default", "GDPR-ok-view-detailed"], a) ? "0" : a.replace("GDPR-ok-view-detailed-", "");
                return h.inArray(xa, a) ? a : null
            },
            setGdprCookie: function(a, b) {
                a.erase("gdpr_popup");
                a.create("gdpr", b, 525600)
            },
            accept: function(a, b, c, d) {
                var f = this.parseValue(d);
                f && (this.setGdprCookie(c, f), this._sender.updateCookies(), this.realise(a, b), this.frameConnector.sendToChildren({
                    type: d
                }))
            },
            getPopupOkEvents: function() {
                return ["GDPR-ok-view-default", "GDPR-ok-view-detailed"].concat(h.map(function(a) {
                    return "GDPR-ok-view-detailed-" + a
                }, xa))
            },
            showPopup: function(a, b, c, d) {
                var f = this;
                h.inArray("ru en et fi lt lv pl".split(" "), a) || (a = "en");
                a = v.loadScript({
                    src: "https://yastatic.net/s3/gdpr/popup/v2/" + a + ".js"
                });
                f.trigger("GDPR-open-start");
                a.onerror = function(a) {
                    D(function() {
                        throw a;
                    }, "gdpr-popup")();
                    f.trigger("GDPR-open-fail");
                    f.realise(b, c);
                    f.frameConnector.sendToChildren({
                        type: "GDPR-ok-view-default"
                    })
                };
                a.onload = function() {
                    f.trigger("GDPR-open-success");
                    f.trigger("22");
                    Ia.handlers = Ia.handlers.concat([{
                        type: f.getPopupOkEvents().join(","),
                        callback: function(a) {
                            a.once || (f.accept(b, c, d, a.type), a.once = !0)
                        }
                    }])
                }
            },
            askGDPR: function(a, b, c, d, f) {
                h.inArray([null, ""], a) && this.showPopup(b, c, d, f)
            },
            handleGdprValue: function(a, b, c) {
                var d = this,
                    f = this._cookie,
                    l = f.read("yaGdprCheck"),
                    g = f.read("gdpr"),
                    m = (u.getLanguage() || "").toLowerCase().split("-")[0];
                if (a || l || d.enabled)
                    if (f.create("gdpr_popup", Lb), d.frameConnector && d.frameConnector.addHandler("isYandex",
                            function() {
                                return {
                                    type: "isYandex",
                                    isYandex: pa()
                                }
                            }), d.frameConnector.isIframe) {
                        d.frameConnector.sendToParents({
                            type: "isYandex"
                        }, function(a, c) {
                            var g = !1;
                            clearTimeout(r);
                            c[0].isYandex ? (d.trigger("GDPR-frame-ya"), h.map(function(a) {
                                d.frameConnector.addHandler(a, function() {
                                    var h = d.parseValue(a);
                                    g || (h && (d.setGdprCookie(f, h), d.realise(c, b)), g = !0)
                                })
                            }, d.getPopupOkEvents())) : (d.trigger("GDPR-frame-noya"), d.realise(c, b))
                        });
                        var r = h.setTimeout(function() {
                            d.trigger("GDPR-frame-skip");
                            d.realise(c, b)
                        }, 2E3)
                    } else d.askGDPR(g,
                        m, c, b, f);
                else return a || (f.create("gdpr", "0"), d.trigger("GDPR-eu-skip")), d.realise(c, b)
            },
            handle: function() {
                var a = this._sender,
                    b = [],
                    ...
                    n = u.isSearchRobot();
                b.size = 0;
                if (l) return l(function() {
                    f.realise(g, b)
                });
                if (!this.enabled && (h.inArray(xa, d) || u.isSafariWebView() || u.isAndroidWebView() || h.inArray(wc, m.location.href.split("?")[0]) || !pa() || c.read("yandex_login") || this.disable || n)) return c.read("yandex_login") ? (this.trigger("GDPR-skip-login"),
                    c.create("gdpr", "0", 525600)) : pa() ? d ? d === Lb ? this.trigger("GDPR-cookie-fail") : this.trigger("GDPR-cookie-success") : u.isSafariWebView() || u.isAndroidWebView() ? this.trigger("GDPR-skip-wv") : n ? this.trigger("28") : this.trigger("GDPR-skip-na") : this.trigger("GDPR-skip-domain"), this.realise(g, b);
                this.globalConfig.set(this.globalKey, function(a, c) {
                    var d = 0;
                    try {
                        d = JSON.stringify(c).length || 0
                    } catch (F) {}
                    b.size + d < f.MAX_SIZE ? (b.push(a), b.size += d) : h.warning("GDPR buffer is exceeded")
                });
                a.hit(function(a) {
                    f.handleGdprValue(a.params.eu,
                        b, g)
                })
            }
        });
    ...
    la.getState = function(a) {
        var b = la.cookie.read("gdpr");
        a = h.reduce(function(a, b) {
            b.ymetrikaEvent && h.inArray(Mb, b.ymetrikaEvent.type) && a.push(h.arrayIndexOf(Mb, b.ymetrikaEvent.type));
            return a
        }, [], a.get("dataLayer"));
        return a.length ? (a = a.join(","), b && (a += "-" + (h.inArray(xa, b) ? b : "")), a) : ""
    };
    la.isAnalyticsCookeAllowed = function(a) {
        var b = la.getState(a).split("-");
        a = b[1];
        var c = b[0].split(",");
    ...
    u.isIE = h.memorize(function() {
        return t && !t.addEventListener || !1
    });
    u.isChromePdf = h.memorize(function() {
    ...
    u.isPrivate = D(function(a) {
        var b = h.bind(a, null,
            0);
        a = h.bind(a, null, 1);
        if (h.isFunction(m.webkitRequestFileSystem) && !u.isAndroid()) return m.webkitRequestFileSystem(0, 0, b, a);
        if (u.isFF()) return "undefined" == typeof navigator.serviceWorker ? a() : b();
        if (u.isSafari() && h.isFunction(m.openDatabase)) try {
    ...
    v.getElementPath = function(a) {
        for (var b = "", c = fc(); a && a.parentNode && "BODY" != a.tagName && "HTML" != a.tagName;) b += c[a.tagName] || "*", b += v.getElementNeighborPosition(a) || "", a = a.parentNode;
    ...
    var yc = W.inherit({
        ...
        zc = J.inherit({
            ...
            start: function() {
                if (!this._start) w.on(t, "click", this._handler, this);
                this._start = !0
            },
            stop: function() {
                this._start && w.un(t, "click", this._handler, this);
                this._start = !1
            },
            setTrackHash: function(a) {
                this.isTrackHash = a
            ...
            _handler: function(a) {
                ...
                if (this._isTrackingClick(a)) {
                    var b = v.getElementSize(a.el);
                    var c = v.getElementXY(a.el);
                    b = ["rn", h.random(), "x", Math.floor(65535 * (a.pos[0] - c[0]) / (b[0] || 1)), "y", Math.floor(65535 * (a.pos[1] - c[1]) / (b[1] || 1)), "t", Math.floor((a.time - this.startTime) / 100), "p", v.getElementPath(a.el), "X", a.pos[0], "Y", a.pos[1]];
                    c = M().href;
                    this.isTrackHash ? h.mergeArrays(b, ["wh", "1"]) : c = c.split("#")[0];
                    this._sender.sendClick(h.trim(c,
                        mb), b.join(":"));
                    this._lastClick = a
                }
            },
            _isTrackingClick: function(a) {
                ...
                if (this._lastClick) {
                    ...
                    b = Math.abs(this._lastClick.pos[1] -
                        a.pos[1]);
        ...
        Nb = J.inherit({
            ...
            getInjectHash: function() {
                var a = {};
                h.forEachKey(this.injectHash,
                    function(b) {
                        a[ya + ("" + h.fnv32a(b))] = this.injectHash[b]
                    }, this);
                return a
            },
            ...
            _initComponent: function() {
                ...
                this.globalConfig.get(this.REMOTE_CONTROL) || (this.globalConfig.set(this.REMOTE_CONTROL, !0), Nb.superclass._initComponent.apply(this, arguments), this._executedMsgs = {}, w.on(m, "message", this._onMessage, this), a.length && (this.globalConfig.set("oo", !0), this.globalConfig.get("stopRecoder", function() {})(), h.arrayEvery(a, function(a) {
                    v.loadScript({
                        src: a
                    }, m);
                    return 1
            ...
            _isAllowedOrigin: function(a) {
                return /^http:\/\/([\w\-.]+\.)?webvisor\.com\/?$/.test(a) || /^https:\/\/([\w\-.]+\.)?metri[kc]a\.yandex\.(ru|ua|by|kz|com|com\.tr)\/?$/.test(a)
            },
            _isAllowedResource: function(a) {
                return /^https:\/\/(yastatic\.net\/s3\/metrika|s3\.mds\.yandex\.net\/internal-metrika-betas|[\w-]+\.dev\.webvisor\.com|[\w-]+\.dev.metrika.yandex.ru)\/(\w|-|\/|(\.)(?!\.))+\.js$/.test(a)
            },
            _onMessage: function(a) {
                ...
                d && this._isAllowedOrigin(d) && (d = aa.parse(a.data)) && "appendremote" === d.action && !this._executedMsgs[d.id] && this._isAllowedResource(d.resource) && (d.inline ? c = d.resource : b = d.resource, b && (this._executedMsgs[d.id] = !0, m._ym__postMessageEvent =
                    a, m._ym__inpageMode = d.inpageMode, m._ym__initMessage = d.initMessage, this._buildRemoteIframe(b)), c && (this._executedMsgs[d.id] = !0, v.loadScript({
                    src: c
                }, m)))
            }
        }),
        Ac = {
            ...
            match: function() {
                this.enabled() && w.ready(function() {
                    var a = this,
                        b = ["https://an.yandex.ru/mapuid/google/", "https://dmp.adform.net/serving/cookie/match?party\x3d1123"],
                        c = !0;
                    h.hiddenFrameCreate("https://mc.yandex.ru/metrika/watch_match.html", this.key);
                    var d = function(a) {
                        if (a.data && a.data.split) {
                            var d = a.data.split("*");
                            "sc.frame" === d[0] &&
                                c ? (c = !1, h.clearTimeout(l), a.source.postMessage("sc.images*" + b.join("*"), "*")) : "sc.image" === d[0] && 1 < d.length && d[1] && (b = h.arrayFilter(b, function(a) {
                                    return a !== d[1]
                                }, null), b.length || (Sa.save("cm", x.getMinutes()), f()))
                        }
                    };
                    var f = function() {
                        w.un(m, "message", d, a, {
                        ...
                        h.hiddenFrameRemove("https://mc.yandex.ru/metrika/watch_match.html", a.key)
                    };
                    var l = h.setTimeout(f, 3E3, "ssp.createFrame");
                    w.on(m, "message", d, this, {
                        passive: !1
                    })
                })
            },
            enabled: function() {
                return 1440 < x.getMinutes() - Sa.getNum("cm") && "tr" === h.getTld()
            }
        };
    D(function() {
        (function(a) {
                ...
                b.detectAd = function() {
                    ...
                    w.forEach(function(d) {
                        ...
                        var n = h + m,
                            ...
                            r = 0 > h ? 0 : h < k ? h : k,
                            q = 0 > g ? 0 : g < e ? g : e;
                        100 <= ((n > k ? k : n > r ? n : r) - r) * ((p > e ? e : p > q ? p : q) - q) && u.push({
                            top: g,
                            left: h,
                            width: m,
                            height: f,
            ...
            9: function(a, b, c) {
                ...
                b.getAdsInWindow = function(a, b) {
                    ...
                    var h = b.isInIFrame,
                        g = a.document.body,
                        l = d.listToArray(g.querySelectorAll("img")),
                        m = d.listToArray(g.querySelectorAll("iframe")),
                        q = d.listToArray(g.querySelectorAll("script")),
                        k = d.listToArray(g.querySelectorAll("div")),
                        e = [],
                        t = [],
                        v = d.listToArray(g.querySelectorAll("yatag")),
                        u = d.listToArray(g.querySelectorAll("yatag yatag"));
                    c("yandex", v.filter(function(a) {
    ...
    var Bc = {
            init: function(a, b) {
                if (Math.random() < (b || .005) && !E.get("adDetect")) {
                    E.set("adDetect", !0);
                    var c = function(b) {
        ...
        Ja = J.inherit({
            awaitSubmitForms: [],
            _initComponent: D(function() {
                T.log("Form goal. Counter " + this.counterId + ". Init.");
                w.on(m, "submit", this.onSubmit, this, {
                    capture: !0,
                    passive: !0
                });
                w.on(m, "click", this.onClick, this, {
                    capture: !0,
                    passive: !0
                });
            ...
            getId: function(a) {
                return this.getAttribute(a, "id")
            },
            getName: function(a) {
                return this.getAttribute(a, "name")
            },
            getIdentifiers: function(a) {
                return {
                    id: this.getId(a),
                    name: this.getName(a),
                    path: v.getElementPath(a)
                }
            },
            transformData: function(a) {
                return "?" + wa.stringify(h.reduce(function(b, c) {
                    var d = a[c];
                    d && (b[Pb[c]] = Qb[c] ? d.slice(0, Qb[c]) : d);
                    return b
                }, {}, h.keys(Pb)), {})
            },
            onClick: D(function(a) {
                a =
                    v.closest(a.target, "button,input");
                var b = this,
                    c;
                "submit" === (a && a.type) && (c = v.closest(a, "form")) && (this.awaitSubmitForms.push(c), h.setTimeout(D(function() {
                    h.inArray(b.awaitSubmitForms, c) && b.submit(c)
                }, "s.f.d"), 300))
            }, "s.f.c"),
            onSubmit: D(function(a) {
                this.submit(a.target)
            }, "s.f.e"),
            submit: function(a) {
                var b = this.transformData(this.getIdentifiers(a));
                T.log("Form goal. Counter " + this.counterId + ". Form: " + b + ".");
                this.awaitSubmitForms = h.filter(function(b) {
                    return b !== a
                }, this.awaitSubmitForms);
                this.cb(b)
            }
        });
    Ja.init = D(function() {
    ...
    var L = M(),
        ...
        Hb = 100,
        lb = "noindex",
        Rb = /\.(3gp|7z|aac|ac3|acs|ai|avi|ape|apk|asf|bmp|bz2|cab|cdr|crc32|css|csv|cue|divx|dmg|djvu?|doc(x|m|b)?|emf|eps|exe|flac?|flv|iso|swf|gif|t?gz|jpe?g?|js|m3u8?|m4a|mp(3|4|e?g?)|m4v|md5|mkv|mov|msi|ods|og(g|m|v)|psd|rar|rss|rtf|sea|sfv|sit|sha1|svg|tar|tif?f|torrent|ts|txt|vob|wave?|wma|wmv|wmf|webm|ppt(x|m|b)?|xls(x|m|b)?|pdf|phps|png|xpi|g?zip)$/i,
        Cc = +new Date,
        ka = "Metrika",
        rb, eb, ya = "1976";
    E.init().setSafe("counters", {}).setSafe("hitParam", {}).setSafe("counterNum", 0).setSafe("dataLayer", []).setSafe("hitId", h.random(1, 1073741824)).setSafe("_globalMetrikaHitId", h.random()).setSafe("v", ya);
    Da.globalConfig = E;
    ka = "Metrika2";
    m.Ya[ka] = function(a, b, c, d) {
        var f = this;
        return D(function() {
            function l(a, b, c) {
                b = new N({
                ...
                if (a) {
                        ...
                        if (d && d.length)
                            for (e = 0; e < d.length; e++) {
                                ...
                                if ("ref" == f.type) var k =
                                    ...
                                    k = l ? f.direct_orders : f.direct_camp;
                                    var sa = t.referrer,
                                        Ha = wa.parse(L.search),
                                        v = y(L.search, L.hash),
                                        u;
                                    var w = Ha;
                                    var x = {};
                                    var oa = ["source", "medium", "campaign", "term", "content"];
                                    for (u = 0; u < oa.length; u++) w["utm_" + oa[u]] && (x[oa[u]] = w["utm_" + oa[u]]);
                                    w = x;
                                    oa = l ? "direct.yandex.ru" : v && v.service || w.source;
                                    u = !1;
                                    if (!u && p && p.length)
                                        for (x = 0; x < p.length; x++)
                                            if ((new RegExp(p[x], "i")).test(oa)) {
                                                u = !0;
                                                break
                                            }
                                    if (!u &&
                                        !f.yandex_direct && q && q.length)
                                        for (p = 0; p < q.length; p++)
                                            if ((new RegExp(q[p], "i")).test(sa)) {
                                                u = !0;
                                                break
                                            }!u && f.google_adwords && Ha.gclid && (u = !0);
                                    if (u && k && k.length && (u = !1, l = l || v && v.campaign || w && w.campaign))
                    ...
                    d = b.read("mp2_track");a = a.substs && a.substs[d];d && a ? (b.create("mp2_substs", h.toJSON(a)), a = n(a), c.params("__ym", a ? "mp_trackid" : "mp_trackid_bad", d)) : r()
                }
                else r()
            }
            ...
            function n(a, b) {
                ...
                if (a && "string" != typeof a && a.length)
                    for (d = 0; d < a.length; d++) {
                        ...
                        e = e.slice(1);
                        if ("#" == h) {
                            if (h = t.getElementById(e)) c = !0, b && ca.unshift([h, h.innerHTML]), h.innerHTML = f
                        } else if ("." == h)
                            for (h = v.getElementsByClassName(e), e = 0; e < h.length; e++) {
                                c = !0;
                                var g = h[e],
                                    k = f;
                                b && ca.unshift([g, g.innerHTML]);
                                g.innerHTML = k
                            }
                    }
                return c
            ...
            function y(a, b) {
                ...
                for (c = 0; c < g.length; c++) {
                    var k = g[c].split("\x26");
                    for (e = 0; e < k.length; e++) f = k[e].split("\x3d"), "_openstat" === f[0] && (d = f[1])
                }
                d && (d = -1 < d.indexOf(";") ? h.safeDecodeURIComponent(d) : Qa.decode(ja.decode(d.replace(/[-*_]/g, function(a) {
                    return {
                        "*": "+",
                        "-": "/",
                        _: "\x3d"
            ...
            function C() {
                var g = !1,
                    n = !1;
                Ca || (n = W.initCookie(za),
                    Da.userInfo = W._userID, zb.init(E));
                Da.initPU(ia, E);
                u.isAndroidWebView() || Da.initPP(E);
                W.retransmit(E);
                na && xc.init(na, Q, a);
                E.get("pri") != A || u.isAndroidWebView() || (E.setSafe("pri", null), u.isPrivate(D(function(a) {
                    E.set("pri", a)
                }, "privCb")));
                if (E.get("hitParam")[V]) {
                    if (1 != c || E.get("counters")[V]) return !1;
                    g = !0
                }
                E.get("counters")[V] = f;
                E.get("hitParam")[V] = 1;
                    ...
                    var p = function(e) {
                        ...
                        g.sendHit({
                            ...
                            callback: function(g, k) {
                                ...
                                Y(h.bind(rc, null, g));
                                n || Da.initZZ();
                                g.eu !== A && E.set("isEU", g.eu);
                                Sa.init(k);
                                Ac.match();
                                uc.sync(a, c, n, E);
                                d || T.log("PageView. Counter ", a, ". URL: ", L.href, ". Referrer: " + t.referrer, ". Params: ", b);
                                g.webvisor && (g.webvisor.isEU = E.get("isEU"));
                                f.isDestructing() || (ma.start(g.webvisor,
                                    g.publisher), l(g.mp2, a, f), w.on(m, "load", f.replacePhones, f));
                                (g.form_goals || -1 < m.location.href.indexOf("yagoalsforms\x3d1")) && new Ja({
                                    counterId: a,
                                    cb: function(a) {
                                        R.sendForm(a, {
                                            url: G.url ? P : M().href
                ...
                0 != h.keys(G).length && (da && da.initUserLayer(), G.enableAll ? (k(!0), B(!0), z()) : (G.clickmap && B(G.clickmap), G.trackLinks && k(G.trackLinks), G.accurateTrackBounce && z(G.accurateTrackBounce)), G.triggerEvent && h.async(function() {
                    U.dispatchCustomEvent("yacounter" +
                        a + "inited")
                }, this, "yacounterInit"))
            }
            ...
            function q(a) {
                ...
                f._isDestructing || (pa = a, b.handle.apply(b, arguments))
            }
            ...
            function e(a) {
                if (f._trackLinks && f._trackLinks.on) {
                    ...
                    if (c && !v.classNameExists(a,
                        ...
                        var g = ub(a);
                        g = c === g ? "" : g;
                        if (v.classNameExists(a, "ym-external-link")) R.sendClickLink({
                            url: c,
                            title: g,
                            modes: d
                        }, P);
                        else {
                            var k = G.url ? h.parseUrl(P).hostname : M().hostname;
                            d.dl = Rb.test(e) || Rb.test(c) || vb(c, Oa) || vb(e, Oa);
                            b = b.hostname;
                            (k ? k.replace(/^www\./, "") : "").toLowerCase() == (b ? b.replace(/^www\./, "") : "").toLowerCase() ? d.dl ? (d.ln = !1, R.sendClickLink({
                                url: c,
                                title: g,
                                modes: d
                            }, P)) : (g = ub(a), xa.set("pai", d.pai), g && g !==
                                c && xa.set("il", h.trim(g, Hb))) : c && -1 !== c.search(/^ *(data|javascript):/i) || (d.ut = lb, R.sendClickLink({
                                url: c,
                                title: g,
                                modes: d
                            }, P))
            ...
            function H(a, b) {
                ...
                var f = !1,
                    ...
                    p = null,
                    q = !1;
                if (u.isIE()) h.setTimeout(a, b, "trackUserTime");
                else {
                    var r = [m, "blur", function() {
                            ...
                            k = !1;
                            c()
                        }, t, "click", d, t, "mousemove", d, t, "keydown", d, t, "scroll",
                        d
                    ];
                    e(!0);
                    c()
            ...
            function z(b) {
                var c = G.referrer ? fa : t.referrer,
                    d = G.url ? P : M().href;
                ...
                if (!f._isAccurateTrackBounce) {
                    ...
                    ((e = e.get("lastHit")) && (!h || h < e - 18E5) || !Vb(c, d) || .1 > Math.random()) && H(function() {
                        f.notBounce();
                        Ea.init(.002, ra)
                    }, b)
                }
            ...
            function J(a) {
                ...
                (function Aa() {
                    var d = b();
                    d !== c && (a(), c = d);
                    ya = h.setTimeout(Aa, 200, "trackHash")
                })()
            }

            function I(a) {
                if (!1 === a) O && ("onhashchange" in m ? w.un(m, "hashchange", K) : h.clearTimeout(ya), O = !1);
                else if (a = K, !O) {
                    if ("onhashchange" in m) w.on(m, "hashchange", a);
                    else J(a);
                    O = !0
                }
                R.setTrackHash(O);
            ...
            function ea(a, b, c) {
                ...
                b = [];
                a && (b.push(a), c = c || {}, h.isFunction(c.callback) && (b.push(c.callback), c.ctx && b.push(c.ctx)));
                b.length && f.params.apply(f, b)
            }
            var ka = "",
                G = {},
                ba = "",
                ua = $a.lastReferrer = L.href,
                ra = .002,
                pa = !1,
                ma;
            E.setSafe("counter", f);
            ...
            if (!m["disableYaCounter" +
                    a]) {
                wa.parse = function(a, b) {
                    var c = {},
                        d;
                    a = a && a.replace(/^\?/, "") || "";
                    if (a.length) {
                        ...
                        for (d = 0; d < e.length; d++)
                            if (e[d]) {
                                var f = e[d].split("\x3d");
                                if (f[0]) {
                                    var g = h.safeDecodeURIComponent(f[0]);
                                    f = h.safeDecodeURIComponent((f[1] || "").replace(/\+/g, "%20"));
                                    b && g in c ? h.isArray(c[g]) ? c[g].push(f) : c[g] = [c[g], f] : c[g] = f
                                }
                            }
                    }
                    return c
                ...
                c = c || 0;
                var V = a + ":" + c;
                if (E.get("counters")[V]) return T.log("Duplicate counter " + V + " initialization"),
                    E.get("counters")[V];
                var Q = E.get("hitId");
                var ia = new Ob({
                    counterId: a,
                ...
                E.set("counterNum", E.get("counterNum") + 1);
                var ha = E.get("counterNum");
                var Y = qc(V, f);
                Y(sc);
                var R = new Ra({
                    protocol: "https:",
                    ...
                    init: function(a, b) {
                        if (m.performance && "function" === typeof performance.getEntriesByType) {
                            ...
                            if (!c || !d) {
                                ...
                                h.keys(n).length && (new Ka(l)).logParams(n)
                            }
                        }
                    }
                };
                ...
                f.hit = p(function(b, c, d, e, g, k) {
                    (b = b && h.isFunction(b.toString) ? b.toString() : !1) ? (h.isObject(c) &&
                        (d = c.referer, e = c.params, g = c.callback, k = c.ctx, c = c.title), P = b, T.log("PageView. Counter " + a, ". URL: " + b, ". Referrer: " + d, ". Params: ", e), R.sendHit({
                            url: b,
                            title: c,
                            hasPrerender: pa,
                            referrer: d,
                ...
                f.params = p(function(b) {
                    ...
                    if (b) {
                        ...
                        (d = -1 !== h.arrayIndexOf(h.keys(e[0]), "__ym") && e[0].__ym.user_id) ? T.log('Set user id "' + e[0].__ym.user_id + '"'): T.log((c ? "User p" : "P") + "arams. Counter " + a + ". Params: ", e[0]);
                        R.sendParams(e[0], g, k, G.url ? P : M().href)
                    } else h.warning("Wrong params");
                    return f
                }, "counter.params");
                ia.addHandler("pluginInfo", function() {
                    return G
                }, this);
                ia.addHandler("parentConnect", function(a, b) {
                    R.paramsQueue.push({
                        __ym: {
                            parentIframe: {
                                counterId: b.counterId,
                ...
                f.file = p(function(b, c) {
                    b ? (c = c || {}, T.log("file. Counter " + a, ". URL: " + b, ". Params: ", c), R.sendFileUpload({
                        url: b,
                        title: c.title,
                        vParams: c.params,
                        callback: c.callback,
                ...
                f.extLink = p(function(b, c) {
                    b ? (c = c || {}, T.log("extLink. Counter " + a, ". URL: " + b, ". Params: ", c), R.sendExtLink({
                        url: b,
                        title: c.title,
                        vParams: c.params,
                        callback: c.callback,
                ...
                f.enableAll = p(function() {
                    k(!0);
                    B(!0);
                    z();
                    return f
                }, "enableAll");
                f.uploadPage = p(function() {}, "uploadPage", !0);
                f.destruct = p(function() {
                    ...
                    E.set("stopRecoder", A);
                    E.set("counter", A);
                    da && da.destruct && da.destruct();
                    B(!1);
                    try {
                        delete m["yaCounter" + a], delete E.get("counters")[V], delete E.get("hitParam")[V]
                    } catch (sa) {}
                });
                ...
                if (a) {
                    ...
                    if ("prerender" === t.webkitVisibilityState || "prerender" === t.visibilityState) {
                        ...
                        var va = function() {
                            "prerender" !== t.webkitVisibilityState && "prerender" !== t.visibilityState && (w.un(t, "webkitvisibilitychange,visibilitychange", va), q(!0))
                        };
                        w.on(t, "webkitvisibilitychange,visibilitychange", va)
                    } else q(!1)
                }
            }
        }, "init")()
    ...
    m.Ya[ka].counters = function() {
        var a = [];
        h.forEachKey(E.get("counters"), function(b, c) {
            var d = b.split(":");
            a.push({
                id: +d[0],
                type: +d[1],
    ...
    E.setSafe("getCounters", function() {
        var a = [];
        h.forEachKey(E.get("counters"), function(b, c) {
            var d = b.split(":");
            a.push({
    ...
    m.Ya[ka].informer = function(a) {
        var b = !!m.Ya[ka]._informer;
        Ya[ka]._informer = a;
        Ya[ka]._informer.domain = "informer.yandex.ru";
        b || v.loadScript({
            src: "https://informer.yandex.ru/metrika/informer.js"
        })
    };
    w.on(t, "click", D(function(a) {
        var b = U.getTarget(a);
